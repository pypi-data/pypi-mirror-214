...
def run_finetuning_experiment_baseline(config=None, params=None, offline=True, validate=False):
    splits = load_splits()
...
if __name__ == "__main__":
    ...
    if args.random:
        ...
        run_finetuning_experiment_baseline(config, params, args.offline, args.validate)
