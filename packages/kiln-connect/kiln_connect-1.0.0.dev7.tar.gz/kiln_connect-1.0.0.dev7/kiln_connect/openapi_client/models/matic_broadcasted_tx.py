...
class MATICBroadcastedTx(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MATICBroadcastedTx:
        """Create an instance of MATICBroadcastedTx from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MATICBroadcastedTx:
        """Create an instance of MATICBroadcastedTx from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MATICBroadcastedTx.parse_obj(obj)

        _obj = MATICBroadcastedTx.parse_obj({
