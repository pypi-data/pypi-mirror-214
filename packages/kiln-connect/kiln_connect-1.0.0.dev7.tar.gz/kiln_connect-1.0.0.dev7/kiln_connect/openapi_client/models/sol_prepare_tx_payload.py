...
class SOLPrepareTxPayload(BaseModel):
    ...
    """
    unsigned_tx_serialized: StrictStr = Field(..., description="Hex encoded unsigned transaction")
    signatures: conlist(StrictStr) = Field(..., description="Hex encoded signatures")
