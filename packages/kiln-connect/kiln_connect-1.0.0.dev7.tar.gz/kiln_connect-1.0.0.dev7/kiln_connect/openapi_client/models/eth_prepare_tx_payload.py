...
class ETHPrepareTxPayload(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ETHPrepareTxPayload:
        """Create an instance of ETHPrepareTxPayload from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ETHPrepareTxPayload:
        """Create an instance of ETHPrepareTxPayload from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ETHPrepareTxPayload.parse_obj(obj)

        _obj = ETHPrepareTxPayload.parse_obj({
