...
class SOLTxStatus(BaseModel):
    ...
    receipt: Optional[Dict[str, Any]] = Field(None, description="Transaction receipt. Object shape can be found [here](https://github.com/solana-labs/solana-web3.js/blob/dfc6d588b4b7c880d74dc727399ee8a84979b480/packages/library-legacy/src/connection.ts#L1071)")
