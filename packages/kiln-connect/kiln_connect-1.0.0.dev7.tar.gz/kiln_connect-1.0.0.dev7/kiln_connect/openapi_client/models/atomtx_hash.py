...
class ATOMTxHash(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ATOMTxHash:
        """Create an instance of ATOMTxHash from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ATOMTxHash:
        """Create an instance of ATOMTxHash from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ATOMTxHash.parse_obj(obj)

        _obj = ATOMTxHash.parse_obj({
