...
class ADATxHash(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ADATxHash:
        """Create an instance of ADATxHash from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ADATxHash:
        """Create an instance of ADATxHash from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ADATxHash.parse_obj(obj)

        _obj = ADATxHash.parse_obj({
