...
class GetEthStakes200Response(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    data: Optional[conlist(ETHStake)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetEthStakes200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetEthStakes200Response:
        """Create an instance of GetEthStakes200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetEthStakes200Response.parse_obj(obj)

        _obj = GetEthStakes200Response.parse_obj({
            "data": [ETHStake.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
