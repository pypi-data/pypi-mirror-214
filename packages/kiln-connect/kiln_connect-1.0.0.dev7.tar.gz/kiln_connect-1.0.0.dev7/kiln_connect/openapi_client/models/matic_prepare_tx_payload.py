...
class MATICPrepareTxPayload(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MATICPrepareTxPayload:
        """Create an instance of MATICPrepareTxPayload from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MATICPrepareTxPayload:
        """Create an instance of MATICPrepareTxPayload from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MATICPrepareTxPayload.parse_obj(obj)

        _obj = MATICPrepareTxPayload.parse_obj({
