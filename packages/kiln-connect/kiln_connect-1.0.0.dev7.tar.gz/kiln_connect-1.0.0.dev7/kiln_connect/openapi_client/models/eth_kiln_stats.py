...
class ETHKilnStats(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    gross_apy: Optional[ETHKilnStatsGrossApy] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ETHKilnStats:
        """Create an instance of ETHKilnStats from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ETHKilnStats:
        """Create an instance of ETHKilnStats from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ETHKilnStats.parse_obj(obj)

        _obj = ETHKilnStats.parse_obj({
            "gross_apy": ETHKilnStatsGrossApy.from_dict(obj.get("gross_apy")) if obj.get("gross_apy") is not None else None
        })
        return _obj
