...
class XTZTxStatus(BaseModel):
    ...
    receipt: Optional[Dict[str, Any]] = Field(None, description="Transaction receipt. Object shape can be found [here](https://github.com/ecadlabs/taquito/blob/master/packages/taquito-rpc/src/types.ts#L1206)")
