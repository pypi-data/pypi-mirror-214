...
class XTZCycleReward(BaseModel):
    ...
    __properties = ["cycle", "cycle_begins_at", "rewards", "active_balance", "gross_apy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> XTZCycleReward:
        """Create an instance of XTZCycleReward from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> XTZCycleReward:
        """Create an instance of XTZCycleReward from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return XTZCycleReward.parse_obj(obj)

        _obj = XTZCycleReward.parse_obj({
            "cycle": obj.get("cycle"),
            "cycle_begins_at": obj.get("cycle_begins_at"),
