...
class ETHCraftStakeTxPayload(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ETHCraftStakeTxPayload:
        """Create an instance of ETHCraftStakeTxPayload from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ETHCraftStakeTxPayload:
        """Create an instance of ETHCraftStakeTxPayload from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ETHCraftStakeTxPayload.parse_obj(obj)

        _obj = ETHCraftStakeTxPayload.parse_obj({
