...
class ETHSignedTx(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ETHSignedTx:
        """Create an instance of ETHSignedTx from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ETHSignedTx:
        """Create an instance of ETHSignedTx from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ETHSignedTx.parse_obj(obj)

        _obj = ETHSignedTx.parse_obj({
