...
class GetEthOperations200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetEthOperations200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetEthOperations200Response:
        """Create an instance of GetEthOperations200Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetEthOperations200Response.parse_obj(obj)

        _obj = GetEthOperations200Response.parse_obj({
            "data": [GetEthOperations200ResponseDataInner.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
