...
from kiln_connect.openapi_client.models.atom_craft_unstake_tx_payload import ATOMCraftUnstakeTxPayload  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestATOMCraftUnstakeTxPayload(unittest.TestCase):
    """ATOMCraftUnstakeTxPayload unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ATOMCraftUnstakeTxPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ATOMCraftUnstakeTxPayload`
        """
        model = kiln_connect.openapi_client.models.atom_craft_unstake_tx_payload.ATOMCraftUnstakeTxPayload()  # noqa: E501
        if include_optional :
            return ATOMCraftUnstakeTxPayload(
    ...
    def testATOMCraftUnstakeTxPayload(self):
        """Test ATOMCraftUnstakeTxPayload"""
