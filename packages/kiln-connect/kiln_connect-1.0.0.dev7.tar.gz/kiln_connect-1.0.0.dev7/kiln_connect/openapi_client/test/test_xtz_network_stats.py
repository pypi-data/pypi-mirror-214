...
from kiln_connect.openapi_client.models.xtz_network_stats import XTZNetworkStats  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestXTZNetworkStats(unittest.TestCase):
    """XTZNetworkStats unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test XTZNetworkStats
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XTZNetworkStats`
        """
        model = kiln_connect.openapi_client.models.xtz_network_stats.XTZNetworkStats()  # noqa: E501
        if include_optional :
            return XTZNetworkStats(
                nb_validators = 402, 
