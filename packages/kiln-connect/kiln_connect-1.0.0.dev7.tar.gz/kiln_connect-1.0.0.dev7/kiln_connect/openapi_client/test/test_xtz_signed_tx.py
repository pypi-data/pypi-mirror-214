...
from kiln_connect.openapi_client.models.xtz_signed_tx import XTZSignedTx  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestXTZSignedTx(unittest.TestCase):
    """XTZSignedTx unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `XTZSignedTx`
        """
        model = kiln_connect.openapi_client.models.xtz_signed_tx.XTZSignedTx()  # noqa: E501
        if include_optional :
            return XTZSignedTx(
