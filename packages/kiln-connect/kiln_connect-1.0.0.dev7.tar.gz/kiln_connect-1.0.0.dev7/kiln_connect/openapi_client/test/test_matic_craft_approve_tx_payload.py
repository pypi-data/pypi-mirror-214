...
from kiln_connect.openapi_client.models.matic_craft_approve_tx_payload import MATICCraftApproveTxPayload  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestMATICCraftApproveTxPayload(unittest.TestCase):
    """MATICCraftApproveTxPayload unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test MATICCraftApproveTxPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MATICCraftApproveTxPayload`
        """
        model = kiln_connect.openapi_client.models.matic_craft_approve_tx_payload.MATICCraftApproveTxPayload()  # noqa: E501
        if include_optional :
            return MATICCraftApproveTxPayload(
    ...
    def testMATICCraftApproveTxPayload(self):
        """Test MATICCraftApproveTxPayload"""
