...
from kiln_connect.openapi_client.models.sol_operation_deactivate import SOLOperationDeactivate  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestSOLOperationDeactivate(unittest.TestCase):
    """SOLOperationDeactivate unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SOLOperationDeactivate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SOLOperationDeactivate`
        """
        model = kiln_connect.openapi_client.models.sol_operation_deactivate.SOLOperationDeactivate()  # noqa: E501
        if include_optional :
            return SOLOperationDeactivate(
                type = 'deactivate', 
    ...
    def testSOLOperationDeactivate(self):
        """Test SOLOperationDeactivate"""
