...
from kiln_connect.openapi_client.models.ada_signed_tx import ADASignedTx  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestADASignedTx(unittest.TestCase):
    """ADASignedTx unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `ADASignedTx`
        """
        model = kiln_connect.openapi_client.models.ada_signed_tx.ADASignedTx()  # noqa: E501
        if include_optional :
            return ADASignedTx(
