...
from kiln_connect.openapi_client.models.xtz_operation_activation import XTZOperationActivation  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestXTZOperationActivation(unittest.TestCase):
    """XTZOperationActivation unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test XTZOperationActivation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XTZOperationActivation`
        """
        model = kiln_connect.openapi_client.models.xtz_operation_activation.XTZOperationActivation()  # noqa: E501
        if include_optional :
            return XTZOperationActivation(
                type = 'activation', 
    ...
    def testXTZOperationActivation(self):
        """Test XTZOperationActivation"""
