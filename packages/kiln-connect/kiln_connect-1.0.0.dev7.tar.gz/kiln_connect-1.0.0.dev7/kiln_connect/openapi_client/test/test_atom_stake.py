...
from kiln_connect.openapi_client.models.atom_stake import ATOMStake  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestATOMStake(unittest.TestCase):
    """ATOMStake unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `ATOMStake`
        """
        model = kiln_connect.openapi_client.models.atom_stake.ATOMStake()  # noqa: E501
        if include_optional :
            return ATOMStake(
