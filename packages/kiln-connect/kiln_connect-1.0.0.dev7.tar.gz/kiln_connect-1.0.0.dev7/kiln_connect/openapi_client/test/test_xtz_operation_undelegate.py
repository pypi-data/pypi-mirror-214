...
from kiln_connect.openapi_client.models.xtz_operation_undelegate import XTZOperationUndelegate  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestXTZOperationUndelegate(unittest.TestCase):
    """XTZOperationUndelegate unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test XTZOperationUndelegate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XTZOperationUndelegate`
        """
        model = kiln_connect.openapi_client.models.xtz_operation_undelegate.XTZOperationUndelegate()  # noqa: E501
        if include_optional :
            return XTZOperationUndelegate(
                type = 'undelegate', 
    ...
    def testXTZOperationUndelegate(self):
        """Test XTZOperationUndelegate"""
