...
from kiln_connect.openapi_client.models.account_payload import AccountPayload  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestAccountPayload(unittest.TestCase):
    """AccountPayload unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `AccountPayload`
        """
        model = kiln_connect.openapi_client.models.account_payload.AccountPayload()  # noqa: E501
        if include_optional :
