...
from kiln_connect.openapi_client.models.core_stake import CoreStake  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestCoreStake(unittest.TestCase):
    """CoreStake unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `CoreStake`
        """
        model = kiln_connect.openapi_client.models.core_stake.CoreStake()  # noqa: E501
        if include_optional :
            return CoreStake(
