...
class XTZUnsignedTx(BaseModel):
    ...
    unsigned_tx: Optional[Dict[str, Any]] = Field(None, description="Transaction object. Object shape can be found [here](https://github.com/ecadlabs/taquito/blob/master/packages/taquito-local-forging/src/interface.ts#L3)")
