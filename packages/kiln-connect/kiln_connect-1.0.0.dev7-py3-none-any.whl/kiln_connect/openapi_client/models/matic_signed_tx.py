...
class MATICSignedTx(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MATICSignedTx:
        """Create an instance of MATICSignedTx from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MATICSignedTx:
        """Create an instance of MATICSignedTx from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MATICSignedTx.parse_obj(obj)

        _obj = MATICSignedTx.parse_obj({
