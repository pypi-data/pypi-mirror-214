...
class XTZSignedTx(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> XTZSignedTx:
        """Create an instance of XTZSignedTx from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> XTZSignedTx:
        """Create an instance of XTZSignedTx from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return XTZSignedTx.parse_obj(obj)

        _obj = XTZSignedTx.parse_obj({
