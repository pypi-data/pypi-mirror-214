...
class XTZDailyReward(BaseModel):
    ...
    __properties = ["date", "rewards", "active_balance", "gross_apy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> XTZDailyReward:
        """Create an instance of XTZDailyReward from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> XTZDailyReward:
        """Create an instance of XTZDailyReward from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return XTZDailyReward.parse_obj(obj)

        _obj = XTZDailyReward.parse_obj({
