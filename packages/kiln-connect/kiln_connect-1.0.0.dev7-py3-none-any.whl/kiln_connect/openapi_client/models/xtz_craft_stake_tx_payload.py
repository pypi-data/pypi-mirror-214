...
class XTZCraftStakeTxPayload(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> XTZCraftStakeTxPayload:
        """Create an instance of XTZCraftStakeTxPayload from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> XTZCraftStakeTxPayload:
        """Create an instance of XTZCraftStakeTxPayload from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return XTZCraftStakeTxPayload.parse_obj(obj)

        _obj = XTZCraftStakeTxPayload.parse_obj({
