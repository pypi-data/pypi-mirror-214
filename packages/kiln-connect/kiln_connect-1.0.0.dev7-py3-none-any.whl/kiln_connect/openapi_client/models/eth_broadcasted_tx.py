...
class ETHBroadcastedTx(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ETHBroadcastedTx:
        """Create an instance of ETHBroadcastedTx from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ETHBroadcastedTx:
        """Create an instance of ETHBroadcastedTx from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ETHBroadcastedTx.parse_obj(obj)

        _obj = ETHBroadcastedTx.parse_obj({
