...
class XTZBroadcastedTx(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> XTZBroadcastedTx:
        """Create an instance of XTZBroadcastedTx from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> XTZBroadcastedTx:
        """Create an instance of XTZBroadcastedTx from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return XTZBroadcastedTx.parse_obj(obj)

        _obj = XTZBroadcastedTx.parse_obj({
