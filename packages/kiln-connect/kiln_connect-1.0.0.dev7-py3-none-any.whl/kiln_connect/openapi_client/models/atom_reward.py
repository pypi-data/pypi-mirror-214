...
class ATOMReward(BaseModel):
    ...
    balance: Optional[StrictStr] = Field(None, description="Staked balance contributing to these rewards")
    net_apy: Optional[float] = Field(None, description="Net annual percentage yield")
    __properties = ["date", "rewards", "balance", "net_apy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ATOMReward:
        """Create an instance of ATOMReward from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ATOMReward:
        """Create an instance of ATOMReward from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ATOMReward.parse_obj(obj)

        _obj = ATOMReward.parse_obj({
