...
class ADACraftStakeTxPayload(BaseModel):
    ...
    pool_id: StrictStr = Field(..., description="Pool id to delegate to")
    __properties = ["account_id", "wallet", "pool_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ADACraftStakeTxPayload:
        """Create an instance of ADACraftStakeTxPayload from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ADACraftStakeTxPayload:
        """Create an instance of ADACraftStakeTxPayload from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ADACraftStakeTxPayload.parse_obj(obj)

        _obj = ADACraftStakeTxPayload.parse_obj({
