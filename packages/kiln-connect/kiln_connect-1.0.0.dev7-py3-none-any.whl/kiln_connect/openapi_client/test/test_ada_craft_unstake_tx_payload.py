...
from kiln_connect.openapi_client.models.ada_craft_unstake_tx_payload import ADACraftUnstakeTxPayload  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestADACraftUnstakeTxPayload(unittest.TestCase):
    """ADACraftUnstakeTxPayload unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ADACraftUnstakeTxPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ADACraftUnstakeTxPayload`
        """
        model = kiln_connect.openapi_client.models.ada_craft_unstake_tx_payload.ADACraftUnstakeTxPayload()  # noqa: E501
        if include_optional :
            return ADACraftUnstakeTxPayload(
    ...
    def testADACraftUnstakeTxPayload(self):
        """Test ADACraftUnstakeTxPayload"""
