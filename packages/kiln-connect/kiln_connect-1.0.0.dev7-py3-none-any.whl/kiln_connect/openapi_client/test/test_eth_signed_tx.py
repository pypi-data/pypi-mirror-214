...
from kiln_connect.openapi_client.models.eth_signed_tx import ETHSignedTx  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestETHSignedTx(unittest.TestCase):
    """ETHSignedTx unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `ETHSignedTx`
        """
        model = kiln_connect.openapi_client.models.eth_signed_tx.ETHSignedTx()  # noqa: E501
        if include_optional :
            return ETHSignedTx(
