...
from kiln_connect.openapi_client.models.ada_prepare_tx_payload import ADAPrepareTxPayload  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestADAPrepareTxPayload(unittest.TestCase):
    """ADAPrepareTxPayload unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ADAPrepareTxPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ADAPrepareTxPayload`
        """
        model = kiln_connect.openapi_client.models.ada_prepare_tx_payload.ADAPrepareTxPayload()  # noqa: E501
        if include_optional :
            return ADAPrepareTxPayload(
                ...
                signed_messages = [
                    kiln_connect.openapi_client.models.ada_prepare_tx_payload_signed_messages_inner.ADAPrepareTxPayload_signed_messages_inner(
                        pubkey = '', 
                        signature = '', )
                    ]
            )
    ...
    def testADAPrepareTxPayload(self):
        """Test ADAPrepareTxPayload"""
