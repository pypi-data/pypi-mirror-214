...
from kiln_connect.openapi_client.models.atom_reward import ATOMReward  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestATOMReward(unittest.TestCase):
    """ATOMReward unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `ATOMReward`
        """
        model = kiln_connect.openapi_client.models.atom_reward.ATOMReward()  # noqa: E501
        if include_optional :
            return ATOMReward(
