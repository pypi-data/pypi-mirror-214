...
from kiln_connect.openapi_client.models.atom_signed_tx import ATOMSignedTx  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestATOMSignedTx(unittest.TestCase):
    """ATOMSignedTx unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `ATOMSignedTx`
        """
        model = kiln_connect.openapi_client.models.atom_signed_tx.ATOMSignedTx()  # noqa: E501
        if include_optional :
            return ATOMSignedTx(
