...
from kiln_connect.openapi_client.models.eth_broadcasted_tx import ETHBroadcastedTx  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestETHBroadcastedTx(unittest.TestCase):
    """ETHBroadcastedTx unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ETHBroadcastedTx
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ETHBroadcastedTx`
        """
        model = kiln_connect.openapi_client.models.eth_broadcasted_tx.ETHBroadcastedTx()  # noqa: E501
        if include_optional :
            return ETHBroadcastedTx(
