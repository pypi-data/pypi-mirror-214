...
from kiln_connect.openapi_client.models.xtz_cycle_reward import XTZCycleReward  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestXTZCycleReward(unittest.TestCase):
    """XTZCycleReward unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `XTZCycleReward`
        """
        model = kiln_connect.openapi_client.models.xtz_cycle_reward.XTZCycleReward()  # noqa: E501
        if include_optional :
            return XTZCycleReward(
                cycle = 271, 
