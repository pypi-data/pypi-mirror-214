...
from kiln_connect.openapi_client.models.atom_unsigned_tx import ATOMUnsignedTx  # noqa: E501
from kiln_connect.openapi_client.rest import ApiException

class TestATOMUnsignedTx(unittest.TestCase):
    """ATOMUnsignedTx unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `ATOMUnsignedTx`
        """
        model = kiln_connect.openapi_client.models.atom_unsigned_tx.ATOMUnsignedTx()  # noqa: E501
        if include_optional :
            return ATOMUnsignedTx(
