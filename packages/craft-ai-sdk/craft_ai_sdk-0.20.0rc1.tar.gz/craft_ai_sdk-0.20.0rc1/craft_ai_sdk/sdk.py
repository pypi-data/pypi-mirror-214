...
class CraftAiSdk:
    ...
    _version = "0.20.0rc1"  # Would be better to share it somewhere
...
'periodic'."
    ...
    def get_metrics(
        ...
        Returns:
            ...
            as :obj:`dict` (with keys ``"name"``, ``"value"``, ``"created_at"``,
    ...
    def get_list_metrics(
        ...
        Returns:
            :obj:`list` of :obj:`dict`: List of execution metric lists
            as :obj:`dict` (with keys ``"name"``, ``"values"``, ``"created_at"``,
            ``"execution_id"``, ``"deployment_name"``, ``"pipeline_name"``).
