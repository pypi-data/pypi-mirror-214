...
class ResolveAction(Dictable):
    ...
    response: Dict[str, "ResolveAction"] = field(default_factory=dict)
    responseCodes: List[str] = field(default_factory=list)
    removeSlots: List[str] = field(default_factory=list)
    setSlots: Dict[str, Any] = field(default_factory=dict)
...
class Context(Dictable):
    ...
    logs: List[Tuple[Intent, List[Entity], Dict]] = field(default_factory=list)
