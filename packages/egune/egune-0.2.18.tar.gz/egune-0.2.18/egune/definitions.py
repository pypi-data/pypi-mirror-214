...
class SlotDef(Dictable):
    ...
    defaultQuestionAnswerValues: Union[None, List[Tuple[Dict, Any]]] = None
...
class IntentDefinition(Dictable):
    ...
    inquiryQuestionCode: Union[None, str] = None
...
class ResolveDefinition(Dictable):
    ...
    availableActions: List[ResolveAction] = field(default_factory=list)
    prohibitedActions: List[ResolveAction] = field(default_factory=list)
