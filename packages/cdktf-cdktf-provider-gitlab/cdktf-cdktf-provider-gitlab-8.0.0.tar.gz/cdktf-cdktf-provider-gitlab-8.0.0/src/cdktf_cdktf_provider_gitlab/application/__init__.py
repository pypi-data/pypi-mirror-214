...
class Application(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: Name of the application. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/15.11.0/docs/resources/application#name Application#name}
        :param redirect_url: The URL gitlab should send the user to after authentication. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/15.11.0/docs/resources/application#redirect_url Application#redirect_url}
        :param scopes: Scopes of the application. Use "openid" if you plan to use this as an oidc authentication application. Valid options are: ``api``, ``read_api``, ``read_user``, ``read_repository``, ``write_repository``, ``read_registry``, ``write_registry``, ``sudo``, ``admin_mode``, ``openid``, ``profile``, ``email``. This is only populated when creating a new application. This attribute is not available for imported resources Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/15.11.0/docs/resources/application#scopes Application#scopes}
        :param confidential: The application is used where the client secret can be kept confidential. Native mobile apps and Single Page Apps are considered non-confidential. Defaults to true if not supplied Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/15.11.0/docs/resources/application#confidential Application#confidential}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
