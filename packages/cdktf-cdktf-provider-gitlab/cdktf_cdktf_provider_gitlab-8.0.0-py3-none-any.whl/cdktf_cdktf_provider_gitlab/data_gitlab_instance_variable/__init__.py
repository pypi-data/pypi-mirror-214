...
class DataGitlabInstanceVariable(
    ...
    def __init__(
        ...
        *,
        ...
        :param key: The name of the variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/15.11.0/docs/data-sources/instance_variable#key DataGitlabInstanceVariable#key}
