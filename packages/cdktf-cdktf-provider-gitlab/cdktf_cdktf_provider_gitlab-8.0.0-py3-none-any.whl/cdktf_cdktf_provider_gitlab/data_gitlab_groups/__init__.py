...
class DataGitlabGroups(
    ...
    def __init__(
        ...
        *,
        ...
        :param order_by: Order the groups' list by ``id``, ``name``, ``path``, or ``similarity``. (Requires administrator privileges). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/15.11.0/docs/data-sources/groups#order_by DataGitlabGroups#order_by}
        :param search: Search groups by name or path. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/15.11.0/docs/data-sources/groups#search DataGitlabGroups#search}
        :param sort: Sort groups' list in asc or desc order. (Requires administrator privileges). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/15.11.0/docs/data-sources/groups#sort DataGitlabGroups#sort}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
