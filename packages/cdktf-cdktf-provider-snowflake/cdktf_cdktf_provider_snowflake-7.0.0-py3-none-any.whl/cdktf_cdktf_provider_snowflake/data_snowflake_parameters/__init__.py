...
class DataSnowflakeParameters(
    ...
    def __init__(
        ...
        *,
        ...
        :param parameter_type: The type of parameter to filter by. Valid values are: "ACCOUNT", "SESSION", "OBJECT". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.66.2/docs/data-sources/parameters#parameter_type DataSnowflakeParameters#parameter_type}
        ...
        :param user: If parameter_type is set to "SESSION" then user is the name of the user to display session parameters for. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.66.2/docs/data-sources/parameters#user DataSnowflakeParameters#user}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
