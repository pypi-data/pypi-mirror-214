...
def make_packmol_input(structures, tolerance=None, seed=-1):
...
def clean_tempfiles(structures):
    ...
    for f in [PACKMOL_INP] + structure_files:
        try:
            os.remove(f)
...
def packmol(structures, tolerance=None, seed=-1):
    ...
    """
    try:
        make_packmol_input(structures, tolerance=tolerance, seed=seed)
