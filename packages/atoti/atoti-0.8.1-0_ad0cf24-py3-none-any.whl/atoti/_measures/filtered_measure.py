    ...
    def _do_distil(
        ...
        *,
        ...
        underlying_measure_to_conditions = {
            measure._distil(java_api=java_api, cube_name=cube_name): conditions
            ...
            conditions.append(
                {
                    "level": LevelCoordinates(
                        hierarchy_isin_condition.subject.dimension_name,
                        hierarchy_isin_condition.subject.hierarchy_name,
