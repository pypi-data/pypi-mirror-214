...
class ChargesConfirmPaymentResponse(object):

    """Implementation of the 'Charges Confirm Payment Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ChargesConfirmPaymentResponse class"""
