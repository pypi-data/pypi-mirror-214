...
import mundiapi.models.period
import mundiapi.models.usages
...
class GetUsagesDetailsResponse(object):
    ...
    Attributes:
        ...
        period (Period): TODO: type description here.
        usages (Usages): TODO: type description here.
    ...
    def from_dictionary(cls,
        ...
        usages = mundiapi.models.usages.Usages.from_dictionary(dictionary.get('Usages')) if dictionary.get('Usages') else None
        period = mundiapi.models.period.Period.from_dictionary(dictionary.get('Period')) if dictionary.get('Period') else None
