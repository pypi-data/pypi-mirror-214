...
class RecipientsDefaultBankAccountResponse(object):

    """Implementation of the 'Recipients Default Bank Account Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the RecipientsDefaultBankAccountResponse class"""
