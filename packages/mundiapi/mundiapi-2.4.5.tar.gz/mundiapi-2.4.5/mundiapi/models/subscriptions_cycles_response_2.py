...
class SubscriptionsCyclesResponse2(object):

    """Implementation of the 'Subscriptions Cycles Response2' model.
    ...
    def __init__(self,
                 data=None,
                 paging=None):
        """Constructor for the SubscriptionsCyclesResponse2 class"""
