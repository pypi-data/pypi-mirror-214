...
class SubscriptionsCyclesPayResponse(object):

    """Implementation of the 'Subscriptions Cycles Pay Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the SubscriptionsCyclesPayResponse class"""
