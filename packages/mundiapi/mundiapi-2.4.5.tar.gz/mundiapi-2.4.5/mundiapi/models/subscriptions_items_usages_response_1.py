...
class SubscriptionsItemsUsagesResponse1(object):

    """Implementation of the 'Subscriptions Items Usages Response1' model.
    ...
    def __init__(self,
                 data=None,
                 paging=None):
        """Constructor for the SubscriptionsItemsUsagesResponse1 class"""
