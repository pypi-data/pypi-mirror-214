...
class ChargesPaymentMethodResponse(object):

    """Implementation of the 'Charges Payment Method Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ChargesPaymentMethodResponse class"""
