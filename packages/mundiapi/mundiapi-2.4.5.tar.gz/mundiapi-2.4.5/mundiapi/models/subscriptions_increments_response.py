...
class SubscriptionsIncrementsResponse(object):

    """Implementation of the 'Subscriptions Increments Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the SubscriptionsIncrementsResponse class"""
