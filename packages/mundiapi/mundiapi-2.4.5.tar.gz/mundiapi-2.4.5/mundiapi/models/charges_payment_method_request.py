...
class ChargesPaymentMethodRequest(object):

    """Implementation of the 'Charges Payment Method Request' model.
    ...
    def __init__(self,
                 ...
                 bank_transfer=None,
                 private_label=None):
        """Constructor for the ChargesPaymentMethodRequest class"""
