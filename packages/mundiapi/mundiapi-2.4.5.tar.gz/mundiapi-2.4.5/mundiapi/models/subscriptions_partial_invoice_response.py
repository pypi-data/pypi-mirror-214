...
class SubscriptionsPartialInvoiceResponse(object):

    """Implementation of the 'Subscriptions Partial Invoice Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the SubscriptionsPartialInvoiceResponse class"""
