...
class SubscriptionsDiscountsResponse(object):

    """Implementation of the 'Subscriptions Discounts Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the SubscriptionsDiscountsResponse class"""
