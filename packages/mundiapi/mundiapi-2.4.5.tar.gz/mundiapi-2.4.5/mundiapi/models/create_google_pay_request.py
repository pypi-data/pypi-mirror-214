...
import mundiapi.models.header_1
...
class CreateGooglePayRequest(object):
    ...
    Attributes:
        ...
        header (Header1): TODO: type description here.
    ...
    def from_dictionary(cls,
        ...
        header = mundiapi.models.header_1.Header1.from_dictionary(dictionary.get('header')) if dictionary.get('header') else None
