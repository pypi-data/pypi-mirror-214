...
class RecipientsAutomaticAnticipationSettingsResponse(object):

    """Implementation of the 'Recipients Automatic Anticipation Settings Response' model.
    ...
    def __init__(self,
        ...
        """Constructor for the RecipientsAutomaticAnticipationSettingsResponse class"""
