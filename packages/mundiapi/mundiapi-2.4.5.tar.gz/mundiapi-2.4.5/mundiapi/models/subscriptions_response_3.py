...
class SubscriptionsResponse3(object):

    """Implementation of the 'Subscriptions Response3' model.
    ...
    def __init__(self,
                 data=None,
                 paging=None):
        """Constructor for the SubscriptionsResponse3 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') != None:
            ...
            for structure in dictionary.get('data'):
                data.append(mundiapi.models.get_subscription_response.GetSubscriptionResponse.from_dictionary(structure))
