...
class SubscriptionsItemsResponse3(object):

    """Implementation of the 'Subscriptions Items Response3' model.
    ...
    def __init__(self,
                 data=None,
                 paging=None):
        """Constructor for the SubscriptionsItemsResponse3 class"""
