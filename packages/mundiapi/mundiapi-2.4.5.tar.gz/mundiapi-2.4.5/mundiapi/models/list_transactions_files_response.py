...
import mundiapi.models.get_transaction_report_file_response
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') != None:
            ...
            for structure in dictionary.get('data'):
                data.append(mundiapi.models.get_transaction_report_file_response.GetTransactionReportFileResponse.from_dictionary(structure))
