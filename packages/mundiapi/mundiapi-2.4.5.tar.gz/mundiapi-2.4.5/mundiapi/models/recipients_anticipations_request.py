...
class RecipientsAnticipationsRequest(object):

    """Implementation of the 'Recipients Anticipations Request' model.
    ...
    def __init__(self,
                 ...
                 timeframe=None,
                 payment_date=None):
        """Constructor for the RecipientsAnticipationsRequest class"""
