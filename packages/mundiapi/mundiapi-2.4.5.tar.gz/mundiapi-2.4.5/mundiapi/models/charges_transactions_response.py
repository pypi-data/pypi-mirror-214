...
class ChargesTransactionsResponse(object):

    """Implementation of the 'Charges Transactions Response' model.
    ...
    def __init__(self,
                 data=None,
                 paging=None):
        """Constructor for the ChargesTransactionsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('data') != None:
            ...
            for structure in dictionary.get('data'):
                data.append(mundiapi.models.get_transaction_response.GetTransactionResponse.from_dictionary(structure))
