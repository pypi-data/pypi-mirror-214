...
from diengine_connect.driver.common import empty_gen, StreamContext
from diengine_connect.driver.exceptions import StreamClosedError
from diengine_connect.driver.types import Closable
