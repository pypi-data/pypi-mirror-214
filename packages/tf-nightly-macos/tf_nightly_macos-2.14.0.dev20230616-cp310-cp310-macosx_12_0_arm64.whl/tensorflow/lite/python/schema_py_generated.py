...
def OperatorAddCustomOptionsOffset(builder, customOptionsOffset):
    builder.PrependUint64Slot(9, customOptionsOffset, 0)

def OperatorAddCustomOptionsSize(builder, customOptionsSize):
    builder.PrependUint64Slot(10, customOptionsSize, 0)
