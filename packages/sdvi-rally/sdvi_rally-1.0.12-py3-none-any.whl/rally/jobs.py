...
def get_jobs_for_asset(asset_name=None, category=None, state=None):
    ...
    :param state: The state of the job to filter for. One or more of 'Active', 'Cancelled', 'Complete', 'Error', 'Hold', 'Queued', 'Rescheduled', 'Retried', 'Skipped', 'Restoring'. Defaults to all states
    ...
    valid_states = ('Active', 'Cancelled', 'Complete', 'Error', 'Hold', 'Queued', 'Rescheduled', 'Retried', 'Skipped', 'Restoring')
    if state:
