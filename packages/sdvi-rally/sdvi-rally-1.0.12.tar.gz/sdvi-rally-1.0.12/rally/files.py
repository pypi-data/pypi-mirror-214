...
class RallyFile:
    ...
    .. note::
            All functions on this class require an instance of a RallyFile to run
    ...
    def refresh(self):
        ...
        File status (RallyFile.locations[].status) is cached in Rally and may be stale if the file has changed.
        The attribute RallyFile.locations[].statusRefreshAt indicates when the file was last checked.
        Call this method if the last refresh has been a while and you think the file may have changed.
        ...
        .. warning::
            This is an expensive operation and should only be called when deemed necessary.
...
def get_inventory(label=None, tag=None, assetName=None):
    ...
    :class:`RallyFile` containing items from an Asset's File Inventory matching the given filters.
