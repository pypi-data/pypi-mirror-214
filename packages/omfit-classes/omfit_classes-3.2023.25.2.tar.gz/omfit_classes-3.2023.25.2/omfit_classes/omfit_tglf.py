...
def reconstruct_kxky_phi(ky_grid, kx_grid, gammas, imode=0, theta_grid=None, make_plots=False, **kw):
    ...
    phi_params = intensity_sat(sat_rule_in, ky_grid, gammas, kx0_e, nmodes, return_phi_params=True, **sat_params, **kw)
    ...
    if sat_rule_in == 2:
        ...
        Gq = 1 / Gq  # WARNING: I think there's a typo in Gary's paper..
...
def sum_ky_spectrum(
    ...
    **kw,
    ...
    elif sat_rule_in in [1.0, 1, 'SAT1', 2.0, 2, 'SAT2']:
        intensity_factor = intensity_sat(sat_rule_in, ky_spect, gp, kx0_e, NM, **kw)
