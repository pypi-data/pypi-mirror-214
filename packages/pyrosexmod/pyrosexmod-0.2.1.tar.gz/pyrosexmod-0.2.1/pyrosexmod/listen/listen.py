...
class ListenerCanceled(Exception):
    pass
pyrosex.errors.ListenerCanceled = ListenerCanceled

@patch(pyrosex.client.Client)
class Client():
    @patchable
...
@patch(pyrosex.handlers.message_handler.MessageHandler)
...
@patch(pyrosex.types.user_and_chats.chat.Chat)
class Chat(pyrosex.types.Chat):
    @patchable
...
@patch(pyrosex.types.user_and_chats.user.User)
class User(pyrosex.types.User):
    @patchable
    def listen(self, *args, **kwargs):
        return self._client.listen(self.id, *args, **kwargs)
    @patchable
