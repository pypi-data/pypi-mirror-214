...
class LogTest(unittest.TestCase):
    ...
    def assert_log_line(self, expected_line_as_regex: str):
        Log.flush()
        with open(Log.log_filepath, "r") as log_file:
...
class RegularLogTest(LogTest):
    ...
    def init_log(self):
        Log.init_logging(self.TEST_COMPONENT_NAME, self.tmp_dir, "DEBUG")
...
class EmergencyLogTest(LogTest):
    ...
    def init_log(self):
        Log.init_emergency_logging(self.TEST_COMPONENT_NAME, log_file_directory=self.tmp_dir)
