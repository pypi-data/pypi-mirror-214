...
class Domain(AbstractDomain, ViewContainer):
    def __init__(
        ...
        temp = ViewContainer({}, {}, {AbstractDomainType: TypedIdsContainer(AbstractDomainType, ())}).with_elements(types, update=True)
    ...
    def related_types(self, obj: Union[Identifiable, str], type_: Type[_DomainType] = AbstractDomainType, *,
                      filter_: Union[Callable[[_DomainType], bool], Iterable[Callable[[_DomainType], bool]]] = tuple()):
