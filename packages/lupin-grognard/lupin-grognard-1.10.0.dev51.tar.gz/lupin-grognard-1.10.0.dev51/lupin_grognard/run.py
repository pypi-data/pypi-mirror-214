...
from lupin_grognard.core.commit.commit_validator import CommitsCheckModes
...
def check_commits(
    ...
    mode_check = CommitsCheckModes(
        current_branch=current_branch_name,
        ci_mr_target_branch=ci_mr_target_branch_name,
        all_checks_flag=all_checks,
    ).mode()

    if (
        mode_check == mode_check.ALL_CHECKS_WITH_JAMA
        or mode_check == mode_check.ALL_CHECKS_WITHOUT_JAMA
    ):
