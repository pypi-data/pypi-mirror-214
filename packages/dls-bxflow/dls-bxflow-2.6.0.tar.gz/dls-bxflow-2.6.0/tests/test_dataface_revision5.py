...
# ----------------------------------------------------------------------------------------
class TestDatafaceRevision5Laptop:
    def test_dataface_laptop(self, constants, logging_setup, output_directory):
        ...
        DatafaceRevision5Tester().main(constants, configuration_file, output_directory)


# ----------------------------------------------------------------------------------------
class DatafaceRevision5Tester(BaseContextTester):
    """
