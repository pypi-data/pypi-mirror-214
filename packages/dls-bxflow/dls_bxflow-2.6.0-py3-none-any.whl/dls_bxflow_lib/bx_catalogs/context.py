...
from dls_bxflow_lib.bx_catalogs.bx_catalogs import BxCatalogs, bx_catalogs_set_default
...
thing_type = "dls_bxflow_lib.bx_catalogs.context"


class Context(ContextBase):
    """
    Asyncio context for a bx_catalog object.
    ...
    async def aenter(self):
        ...
        self.server = BxCatalogs().build_object(self.specification())

        # If there is more than one catalog, the last one defined will be the default.
        bx_catalogs_set_default(self.server)
