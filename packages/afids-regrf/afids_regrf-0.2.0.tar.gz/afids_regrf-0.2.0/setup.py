...
packages = \
['afids_regrf',
 'afids_regrf.modelling.workflow.scripts',
 'afids_regrf.modelling.workflow.scripts.commonsmk',
...
package_data = \
{'': ['*'],
 'afids_regrf': ['modelling/config/*',
                 'modelling/resources/*',
                 'modelling/workflow/*',
                 'modelling/workflow/envs/*',
                 'modelling/workflow/rules/*',
                 'registration/config/*',
