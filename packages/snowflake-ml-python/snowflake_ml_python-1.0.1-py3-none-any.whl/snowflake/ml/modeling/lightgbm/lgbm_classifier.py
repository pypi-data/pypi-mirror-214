...
class LGBMClassifier(BaseTransformer):
    ...
    def to_sklearn(self) -> Any:
        raise AttributeError("Estimator doesn't support to_sklearn(). Please use to_lightgbm()")

    def to_xgboost(self) -> Any:
        raise AttributeError("Estimator doesn't support to_xgboost(). Please use to_lightgbm()")
