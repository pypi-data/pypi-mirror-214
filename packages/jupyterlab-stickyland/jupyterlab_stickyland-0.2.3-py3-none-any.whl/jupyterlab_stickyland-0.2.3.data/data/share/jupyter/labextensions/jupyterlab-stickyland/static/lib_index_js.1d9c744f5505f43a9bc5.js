...
class ButtonExtension {
    ...
    shell;
    notebookTracker;
    constructor(shell, notebookTracker) {
        this.shell = shell;
        ...
        this.notebookTracker.currentChanged.connect((sender, panel) => {
            console.log('changed');
            const widgets = this.shell.widgets().iter();
            this.shell.widgets();
            console.log(widgets);
        });
    }
...
const plugin = {
    ...
    activate: function (app, notebookTracker) {
        ...
        app.docRegistry.addWidgetExtension('Notebook', new _button__WEBPACK_IMPORTED_MODULE_1__.ButtonExtension(app.shell, notebookTracker));
    }
};
...
//# sourceMappingURL=lib_index_js.1d9c744f5505f43a9bc5.js.map