...
class ButtonExtension {
    ...
    notebookTracker;
    documentManager;
    constructor(shell, notebookTracker, documentManager) {
        this.shell = shell;
        ...
        // a notebook
        this.notebookTracker.widgetUpdated.connect((sender, panel) => {
            const widgetIter = this.shell.widgets();
            const openPaths = new Set();
            let nextWidget = widgetIter.next();
            while (nextWidget !== undefined) {
                console.log(nextWidget.isHidden, nextWidget.isVisible);
                console.log(nextWidget.node.parentNode);
    ...
    createNew(panel, context) {
        ...
        const onClickHandler = () => {
            ...
            console.log(this.stickyLandMap);
            // Create it if we don't have it yet
            if (!this.stickyLandMap?.has(curPath)) {
                this.stickyLandMap?.set(curPath, new _stickyland__WEBPACK_IMPORTED_MODULE_2__.StickyLand(panel));
            }
...
/* harmony import */ var _content__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./content */ "./lib/content.js");
/* harmony import */ var _floating__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./floating */ "./lib/floating.js");
...
class StickyCode {
    ...
    static createFromExistingCell(stickyContent, cell, notebook) {
        ...
        _icons__WEBPACK_IMPORTED_MODULE_3__.MyIcons.ellipsesIcon.element({ container: placeholderIcon });
     ...
     */
    codeOutputMutationHandler = (mutationList, observer) => {
     ...
     * @param observer The observer itself
     */
    codeClassMutationHandler = (mutationList, observer) => {
        mutationList.forEach(d => {
     ...
     */
    handleExecutionScheduled = (_, args) => {
    ...
    float = () => {
        ...
        // window
        this.floatingWindow = new _floating__WEBPACK_IMPORTED_MODULE_4__.FloatingWindow(_content__WEBPACK_IMPORTED_MODULE_5__.ContentType.Code, this);
    ...
    toolBarItems = [
        ...
        },
        {
            ...
            icon: _icons__WEBPACK_IMPORTED_MODULE_3__.MyIcons.collapseIcon,
            onClick: this.collapseClicked
        },
        {
            name: 'expand',
            title: 'Show the input',
            icon: _icons__WEBPACK_IMPORTED_MODULE_3__.MyIcons.expandIcon,
...
class StickyContent {
     ...
     */
    swapDropzoneWithExistingCell = (cell, newCellType) => {
        // Remove the dropzone
     ...
     */
    swapDropzoneWithNewCell = (newCellType) => {
        switch (newCellType) {
            case ContentType.Code:
                // Remove the dropzone
                this.curContent.dispose();
...
class Dropzone {
    ...
    constructor(stickyContent) {
        ...
        _icons__WEBPACK_IMPORTED_MODULE_1__.MyIcons.addIcon.element({ container: addIconElem });
        // Add a text label
        ...
        _icons__WEBPACK_IMPORTED_MODULE_1__.MyIcons.caretDownEmptyIcon.element({
        ...
        const newCellOptions = [
            { name: 'Select new cell type', type: _content__WEBPACK_IMPORTED_MODULE_2__.ContentType.Dropzone },
            { name: 'Code', type: _content__WEBPACK_IMPORTED_MODULE_2__.ContentType.Code },
            { name: 'Markdown', type: _content__WEBPACK_IMPORTED_MODULE_2__.ContentType.Markdown }
        ];
        newCellOptions.forEach(o => {
            const option = document.createElement('option');
            option.value = _content__WEBPACK_IMPORTED_MODULE_2__.ContentType[o.type];
    ...
    dragDropHandler = (event) => {
        ...
        if (event.source.activeCell instanceof _jupyterlab_cells__WEBPACK_IMPORTED_MODULE_0__.MarkdownCell) {
            ...
            cellContentType = _content__WEBPACK_IMPORTED_MODULE_2__.ContentType.Markdown;
        }
        else {
            cell = notebook.content.activeCell;
            cellContentType = _content__WEBPACK_IMPORTED_MODULE_2__.ContentType.Code;
        }
    ...
    createClickHandler = (event) => {
        ...
        switch (curOption) {
            case _content__WEBPACK_IMPORTED_MODULE_2__.ContentType.Code:
                this.stickyContent.swapDropzoneWithNewCell(_content__WEBPACK_IMPORTED_MODULE_2__.ContentType.Code);
                break;
            case _content__WEBPACK_IMPORTED_MODULE_2__.ContentType.Markdown:
                this.stickyContent.swapDropzoneWithNewCell(_content__WEBPACK_IMPORTED_MODULE_2__.ContentType.Markdown);
                break;
            case _content__WEBPACK_IMPORTED_MODULE_2__.ContentType.Dropzone:
...
/* harmony export */ });
/* harmony import */ var _content__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./content */ "./lib/content.js");
/* harmony import */ var _icons__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./icons */ "./lib/icons.js");
...
class FloatingWindow {
    ...
    constructor(cellType, stickyCell) {
        ...
        if (cellType === _content__WEBPACK_IMPORTED_MODULE_0__.ContentType.Code) {
        ...
        _icons__WEBPACK_IMPORTED_MODULE_1__.MyIcons.landIcon.element({ container: icon1 });
        headerIcons.appendChild(icon1);
        const icon2 = document.createElement('div');
        icon2.classList.add('header-button');
        icon2.setAttribute('title', 'Close the cell');
        _icons__WEBPACK_IMPORTED_MODULE_1__.MyIcons.closeIcon2.element({ container: icon2 });
        ...
        const launchIcon = this.stickyCell.stickyContent.headerNode.querySelector('.button-launch')?.parentElement;
    ...
    addPlaceholder = () => {
        ...
        _icons__WEBPACK_IMPORTED_MODULE_1__.MyIcons.launchIcon.element({ container: addIconElem });
        // Add a text label
        const label = document.createElement('span');
...
class MyIcons {
    static runIcon = _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.runIcon;
    static editIcon = _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.editIcon;
    static ellipsesIcon = _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.ellipsesIcon;
    static closeIcon = _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.closeIcon;
    static caretDownEmptyIcon = _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.caretDownEmptyIcon;
    static addIcon2 = _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.addIcon;
    static addIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.LabIcon({
        name: 'icon-add',
        svgstr: _style_img_icon_add_svg__WEBPACK_IMPORTED_MODULE_1__["default"]
    });
    static collapseIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.LabIcon({
        name: 'icon-collapse',
        svgstr: _style_img_icon_collapse_svg__WEBPACK_IMPORTED_MODULE_2__["default"]
    });
    static launchIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.LabIcon({
        name: 'icon-launch',
        svgstr: _style_img_icon_launch_svg__WEBPACK_IMPORTED_MODULE_3__["default"]
    });
    static landIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.LabIcon({
        name: 'icon-land',
        svgstr: _style_img_icon_land_svg__WEBPACK_IMPORTED_MODULE_4__["default"]
    });
    static closeIcon2 = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.LabIcon({
        name: 'icon-close2',
        svgstr: _style_img_icon_close2_svg__WEBPACK_IMPORTED_MODULE_5__["default"]
    });
    static expandIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.LabIcon({
        name: 'icon-expand',
        svgstr: _style_img_icon_expand_svg__WEBPACK_IMPORTED_MODULE_6__["default"]
    });
    static chevronIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.LabIcon({
        name: 'icon-chevron',
        svgstr: _style_img_icon_chevron_svg__WEBPACK_IMPORTED_MODULE_7__["default"]
    });
    static dragIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.LabIcon({
        name: 'icon-drag',
        svgstr: _style_img_icon_drag_svg__WEBPACK_IMPORTED_MODULE_8__["default"]
    });
    static tabCloseIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_0__.LabIcon({
        name: 'icon-tabClose',
...
/* harmony import */ var _button__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./button */ "./lib/button.js");
/* harmony import */ var _jupyterlab_notebook__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @jupyterlab/notebook */ "webpack/sharing/consume/default/@jupyterlab/notebook");
/* harmony import */ var _jupyterlab_notebook__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_jupyterlab_notebook__WEBPACK_IMPORTED_MODULE_1__);
...
const plugin = {
    ...
    autoStart: true,
    requires: [_jupyterlab_notebook__WEBPACK_IMPORTED_MODULE_1__.INotebookTracker, _jupyterlab_docmanager__WEBPACK_IMPORTED_MODULE_0__.IDocumentManager],
    activate: function (app, notebookTracker, documentManager) {
        console.log('Activating StickyLand.');
        app.docRegistry.addWidgetExtension('Notebook', new _button__WEBPACK_IMPORTED_MODULE_2__.ButtonExtension(app.shell, notebookTracker, documentManager));
    }
};
...
/* harmony export */ });
/* harmony import */ var _tab__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tab */ "./lib/tab.js");
/* harmony import */ var _icons__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./icons */ "./lib/icons.js");
...
class StickyLand {
    ...
    constructor(panel) {
        ...
        this.initHeader();
        // Add the tab element
        this.stickyTab = new _tab__WEBPACK_IMPORTED_MODULE_0__.StickyTab(this.node, panel, this);
    ...
    initHeader = () => {
        ...
        _icons__WEBPACK_IMPORTED_MODULE_1__.MyIcons.dragIcon.element({ container: dragHandle });
...
class StickyTab {
    ...
    tabs = [];
    autoRunTimeout = null;
    autoRunningCellNodes = new Set([]);
    autoRunCells = new Array();
    autoRunTabs = new Array();
    isDisposed = false;
    constructor(stickyContainer, panel, stickyLand) {
        this.stickyContainer = stickyContainer;
        this.stickyLand = stickyLand;
        ...
        _icons__WEBPACK_IMPORTED_MODULE_1__.MyIcons.addIcon2.element({ container: this.addButton });
    ...
    handleExecutionScheduled = (_, args) => {
        ...
        this.tabs.forEach(d => {
            if (d.cellType === _content__WEBPACK_IMPORTED_MODULE_2__.ContentType.Code) {
    ...
    createTab = () => {
        ...
        _icons__WEBPACK_IMPORTED_MODULE_1__.MyIcons.tabCloseIcon.element({ container: tabIcon });
        tabNode.appendChild(tabIcon);
        // New tab always has the dropzone content
        tabLabel.innerHTML = 'New';
        const tabContent = new _content__WEBPACK_IMPORTED_MODULE_2__.StickyContent(this.stickyContainer, this.notebook, this.stickyLand);
        // Add this tab to the model and view
        const newTab = {
            cellType: _content__WEBPACK_IMPORTED_MODULE_2__.ContentType.Dropzone,
            cellIndex: 0,
            tabNode: tabNode,
    ...
    updateActiveTab = () => {
        if (this.activeTab) {
            ...
            let newCellType = _content__WEBPACK_IMPORTED_MODULE_2__.ContentType.Dropzone;
            if (newContent instanceof _code__WEBPACK_IMPORTED_MODULE_3__.StickyCode) {
                newCellType = _content__WEBPACK_IMPORTED_MODULE_2__.ContentType.Code;
            }
            else if (newContent instanceof _markdown__WEBPACK_IMPORTED_MODULE_4__.StickyMarkdown) {
                newCellType = _content__WEBPACK_IMPORTED_MODULE_2__.ContentType.Markdown;
            }
...
//# sourceMappingURL=lib_index_js.a25ba4e502d95e0767c3.js.map