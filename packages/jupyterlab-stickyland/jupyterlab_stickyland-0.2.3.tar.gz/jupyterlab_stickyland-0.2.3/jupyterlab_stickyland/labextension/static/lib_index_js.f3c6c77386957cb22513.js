...
class ButtonExtension {
    ...
    createNew(panel, context) {
        ...
        const onClickHandler = () => {
            ...
            console.log(panel, context, curPath, this.stickyLandMap);
...
const plugin = {
    ...
    activate: function (app, notebookTracker) {
        ...
        notebookTracker.widgetAdded.connect((sender, notebookPanel) => {
            // Add your logic here to handle the notebook being added
            console.log('Notebook added:', notebookPanel.title.label);
            // Listen for the `widgetChanged` event
            notebookPanel.context.model.contentChanged.connect(() => {
                console.log(notebookPanel.context.model.contentChanged);
                // if (notebookPanel.context.model.contentChanged.isConnected) {
                //   // Notebook closed or changed
                //   console.log('Notebook closed:', notebookPanel.title.label);
                // }
            });
        });
        app.docRegistry.addWidgetExtension('Notebook', new _button__WEBPACK_IMPORTED_MODULE_1__.ButtonExtension(app.shell));
    }
};
...
//# sourceMappingURL=lib_index_js.f3c6c77386957cb22513.js.map