...
class FrontendSiteSettings:
    ...
    #: Whether students are allowed to hand when no deadline or lock date is
    #: set on the assignment.
    allow_handin_with_unset_deadline: Maybe["bool"] = Nothing
    ...
    data_parser: t.ClassVar = rqa.Lazy(
        lambda: rqa.FixedMapping(
            ...
            rqa.OptionalArgument(
                "ALLOW_HANDIN_WITH_UNSET_DEADLINE",
                rqa.SimpleValue.bool,
                doc=(
                    "Whether students are allowed to hand when no deadline or"
                    " lock date is set on the assignment."
                ),
            ),
            rqa.OptionalArgument(
    ...
    def __post_init__(self) -> None:
        ...
        self.allow_handin_with_unset_deadline = maybe_from_nullable(
            self.allow_handin_with_unset_deadline
        )
    ...
    def to_dict(self) -> t.Dict[str, t.Any]:
        ...
        if self.allow_handin_with_unset_deadline.is_just:
            res["ALLOW_HANDIN_WITH_UNSET_DEADLINE"] = to_dict(
                self.allow_handin_with_unset_deadline.value
            )
    ...
    def from_dict(
        ...
        res = cls(
            ...
            allow_handin_with_unset_deadline=parsed.ALLOW_HANDIN_WITH_UNSET_DEADLINE,
