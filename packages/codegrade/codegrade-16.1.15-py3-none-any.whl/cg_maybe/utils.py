...
def min(items: t.Iterator[_SupportsLessThan[_T]]) -> Maybe[_T]:  # pylint: disable=redefined-builtin
...
def max(items: t.Iterator[_SupportsLessThan[_T]]) -> Maybe[_T]:  # pylint: disable=redefined-builtin
