...
class UDFResponse(Model):
    ...
    def __init__(self, *, udf_id: int=None, name: str=None, udf_type: str=None, data_type=None, display_order: int=None, udf_select_values=None, count: int=None, locked: bool=None, **kwargs) -> None:
