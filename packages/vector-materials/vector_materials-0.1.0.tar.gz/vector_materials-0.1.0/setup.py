...
setup(
    ...
    # '''
    description = 'A library of functions for materials science',
    ...
    author = 'Vicente Orts',
    author_email = 'vicente@vectorhomes.co.uk',
    ...
    download_url = 'https://github.com/vinceyvincey/vector_materials/archive/refs/tags/v0.1.0.tar.gz',
