...
class HyperparameterTuning:
    ...
    def run(self,
        ...
        response = self.easymaker_api_sender.run_hyperparameter_tuning(hyperparameter_tuning_name=hyperparameter_tuning_name,
                                                                       ...
                                                                       tag_list=tag_list,
                                                                       use_log=use_log,
                                                                       metric_list=list(map(convertMetricFormat, metric_list)),
                                                                       metric_regex=metric_regex,
                                                                       objective_metric=convertMetricFormat(objective_metric_name),
        ...
        if wait:
            ...
            while hyperparameter_tuning_status != 'COMPLETE':
                ...
                if '_FAILED' in hyperparameter_tuning_status or 'FAIL_TRAIN' in hyperparameter_tuning_status or 'STOPPED' in hyperparameter_tuning_status:
