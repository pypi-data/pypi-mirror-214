from app.ocr.core.modules.corner_detection.id_card_aligment import align_image
from app.ocr.core.commons.config import Config
from app.ocr.core.modules.mrc.utils import mrc_crop_model, mrc_detect_model
from app.ocr.core.modules.passport.passport_detection import passport_detect_model
