...
from app.ocr.core.modules.vietnamese_nlp.vietocr.model.transformerocr import VietOCR
from app.ocr.core.modules.vietnamese_nlp.vietocr.model.vocab import Vocab
from app.ocr.core.modules.vietnamese_nlp.vietocr.model.beam import Beam
...
def process_input(image, image_height, image_min_width, image_max_width):
    ...
    # return img
    return torch.FloatTensor(img[np.newaxis, ...])
