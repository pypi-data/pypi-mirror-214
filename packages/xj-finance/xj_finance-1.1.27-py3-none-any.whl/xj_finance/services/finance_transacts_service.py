...
class FinanceTransactsService:
    ...
    def list(params, user_id):
        ...
        account_bank_card_list, err = UserBankCardsService.list(allow_user_list=account_bank_card_id_list)
        ...
        their_account_bank_card_list, err = UserBankCardsService.list(allow_user_list=their_account_bank_card_id_list)
        ...
        if order_no:
            transact_filter_obj = transact_obj.filter(
                order_no=order_no, sand_box__isnull=False).values("platform_id", "transact_no", "thread_id",
                                                                  ...
                                                                  "remark", "images",
                                                                  "finance_status_code",
                                                                  "bookkeeping_type", "account_bank_card_id",
