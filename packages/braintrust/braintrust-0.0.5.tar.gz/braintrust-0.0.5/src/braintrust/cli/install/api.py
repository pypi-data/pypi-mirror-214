...
def build_parser(subparsers, parents):
    ...
    parser.add_argument("--create", help="Create the stack if it does not exist", action="store_true", default=False)
    parser.add_argument("--vpc-connect", help="Connect to an existing VPC", action="store_true", default=False)
    parser.add_argument(
        "--template",
    ...
    parser.add_argument(
        "--provisioned-concurrency", help="The amount of provisioned concurrency", default=None, type=int
    )
    ...
    parser.add_argument(
        "--dw-type", help="The type of the data warehouse", default=None, choices=[None, "Redshift", "Snowflake"]
    )
