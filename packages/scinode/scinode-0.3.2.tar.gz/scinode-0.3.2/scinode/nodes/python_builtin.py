...
class Dict(Node):
    ...
    def create_sockets(self):
        ...
        if self.properties["function"].value in ["dict"]:
            ...
            pass
        elif self.properties["function"].value in ["keys"]:
            self.outputs.new("General", "keys")
        elif self.properties["function"].value in ["values"]:
            self.outputs.new("General", "values")
        elif self.properties["function"].value in ["items"]:
            self.outputs.new("General", "item")
