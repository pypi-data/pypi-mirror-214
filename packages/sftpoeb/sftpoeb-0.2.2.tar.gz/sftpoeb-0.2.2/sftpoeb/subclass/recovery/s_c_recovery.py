...
class ProcessRecovery():
    ...
    def recover_sign(self, split_data_one_to_one , local_pdf_output , remote_pdf_output , local_xml_output , remote_xml_output , path_single_file , payload_user , date_now , time_now , path_recover):
        for fullname in split_data_one_to_one:
            ...
            try:
                service = serviceSigning(self.payload, fullname, path_single_file, 0, self.payload["ServiceCode"])
    ...
    def recover_sign_pack_2(self, split_data_one_to_one , local_pdf_output , remote_pdf_output , local_xml_output , remote_xml_output , path_single_file , payload_user , date_now , time_now , path_recover):
        for fullname in split_data_one_to_one:
            name = str(fullname).split('.')[0]
            try:
                ServiceCode = "S06"
