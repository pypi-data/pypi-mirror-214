...
class WorkDao:
    ...
    def ensure_protocol_integrity(self) -> None:
        ...
        if not protocols_exist:
            raise IOError(
                "Work info file found, but records directory is empty! "
                "Did you accidentally delete your records? To reinitialize, "
                "delete the working directory and try again."
            )
    ...
    class InfoFileDao:
        ...
        def load(self) -> None:
            ...
            with self.file.open(mode="r") as info_file:
                try:
        ...
        def write(self) -> None:
            ...
            with self.file.open(mode="w") as info_file:
                json.dump(info_file_content, info_file, indent="\t")
