...
class BaseTestJobs(unittest.IsolatedAsyncioTestCase):
    def setUp(self):
        self.job_executor = JobExecutor(redis_client=get_redis_test_client(), redis_config=get_redis_config(), consumer=True, import_workers=1, query_workers=1, export_sink_workers=1)
