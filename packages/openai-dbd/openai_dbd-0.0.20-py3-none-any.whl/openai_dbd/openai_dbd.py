...
def correct_schema(sql_schema, open_ai_data):
    ...
    I have designed database schema but i am not sure weather it is correct or not.

    I want you to act as SQL Expert and Correct my mistakes and help me to get done my project.

    I want you help to redesign schema with all tables and normalization and modify table details,
    If you find it may cause performance issue. 
    Also i want you to test constraints in it. 
    If you feel any table fields are required to added you can add them.

    Here is my SQL schema
    `{sql_schema}`

    I want you to only response with SQL queries, Don't include any kind of extra text in response
    like explanations and any text, also dont add starting or ending text in response which you usually 
    write.
    """
