...
def correct_schema(feature, sql_schema, open_ai_data):
    promptX = f"""
    I want you to act as SQL Teacher, 
    I will give you SQL query and you will only reply me with the SQL Query.

    I want you to help me to do some necessary changes like 
    normalization, performance and add required database fields in existing SQL queries.

    What ever schema i am providing you are required to build my project so 
    please keep all existing tables and provide with corrections.

    These are some changes i want to make
    `{feature}`

    Reply only in SQL Query, no explanation or any other text at the beginning of your response and ending 
    are not required.
