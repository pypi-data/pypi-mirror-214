...
def correct_schema(feature, sql_schema, open_ai_data):
    ...
    I want you to look into schema i provide you and do some necessary changes like 
    normalization, performance and add required database fields.

    What ever schema i am providing you are required to build my project so 
    please reply with all tables including in it.
