...
setup(
  name = 'pdf-invoicing',         #* Your package will have this name
  packages = ['pdf_invoicing'],   #* Name the package again
  ...
  author = 'Sujay Barma',                   # Your name
  author_email = 'smith.harry124@gmail.com',  # Your email
