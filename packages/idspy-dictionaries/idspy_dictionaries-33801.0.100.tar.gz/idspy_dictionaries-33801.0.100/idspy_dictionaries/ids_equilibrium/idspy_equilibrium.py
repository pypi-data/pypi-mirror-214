...
class EquilibriumConstraints0D(IdsBaseClass):
    ...
    :ivar reconstructed: Value calculated from the reconstructed
        equilibrium
    :ivar chi_squared: Squared error normalized by the standard
...
class EquilibriumBoundary(IdsBaseClass):
    ...
    lcfs: Optional[Rz1DDynamicAos] = field(
        default=None
    )
    psi_norm: float = field(
        default=9e+40
    )
    b_flux_pol_norm: float = field(
        default=9e+40
    )
    psi: float = field(
        default=9e+40
    ...
    elongation_upper: float = field(
        default=9e+40
    )
    elongation_lower: float = field(
        default=9e+40
    )
    triangularity: float = field(
        default=9e+40
    )
    triangularity_upper: float = field(
        default=9e+40
    )
    triangularity_lower: float = field(
        default=9e+40
    )
    squareness_upper_inner: float = field(
        default=9e+40
    )
    squareness_upper_outer: float = field(
        default=9e+40
    )
    squareness_lower_inner: float = field(
        default=9e+40
    )
    squareness_lower_outer: float = field(
        default=9e+40
    )
    x_point: list[Rz0DDynamicAos] = field(
        default_factory=list
    )
    strike_point: list[Rz0DDynamicAos] = field(
        default_factory=list
    )
    active_limiter_point: Optional[Rz0DDynamicAos] = field(
        default=None
    )
...
class EquilibriumBoundarySecondSeparatrix(IdsBaseClass):
    ...
    distance_inner_outer: float = field(
        default=9e+40
    )
    x_point: list[Rz0DDynamicAos] = field(
        default_factory=list
...
class EquilibriumConstraints0DPosition(IdsBaseClass):
    ...
    position: Optional[Rzphi0DDynamicAos3] = field(
        default=None
    )
    source: str = field(
        default=""
...
class EquilibriumConstraintsMagnetisation(IdsBaseClass):
    ...
    magnetisation_r: Optional[EquilibriumConstraints0D] = field(
        default=None
    )
    magnetisation_z: Optional[EquilibriumConstraints0D] = field(
        default=None
    )
...
class EquilibriumConstraintsPurePosition(IdsBaseClass):
    ...
    :ivar chi_squared_r: Squared error on the major radius normalized by
        the standard deviation considered in the minimization process :
    ...
    :ivar chi_squared_z: Squared error on the altitude normalized by the
        standard deviation considered in the minimization process :
        chi_squared = weight^2 *(position_reconstructed/z -
        position_measured/z)^2 / sigma^2, where sigma is the standard
        deviation of the measurement error
    """
    class Meta:
    ...
    chi_squared_r: float = field(
        default=9e+40
    )
    chi_squared_z: float = field(
        default=9e+40
    )
...
class EquilibriumConvergence(IdsBaseClass):
    ...
    iterations_n: int = field(
        default=999999999
    )
    grad_shafranov_deviation_expression: Optional[IdentifierDynamicAos3] = field(
        default=None
    )
    grad_shafranov_deviation_value: float = field(
        default=9e+40
    )
...
class EquilibriumCoordinateSystem(IdsBaseClass):
    ...
    g11_covariant: list[ndarray[(int,int), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    g12_covariant: list[ndarray[(int,int), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    g13_covariant: list[ndarray[(int,int), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    g22_covariant: list[ndarray[(int,int), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    g23_covariant: list[ndarray[(int,int), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    g33_covariant: list[ndarray[(int,int), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    g11_contravariant: list[ndarray[(int,int), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    g12_contravariant: list[ndarray[(int,int), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    g13_contravariant: list[ndarray[(int,int), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    g22_contravariant: list[ndarray[(int,int), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    g23_contravariant: list[ndarray[(int,int), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    g33_contravariant: list[ndarray[(int,int), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
...
class EquilibriumProfiles1D(IdsBaseClass):
    ...
    :ivar j_parallel: Flux surface averaged parallel current density =
    ...
    f: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    dpressure_dpsi: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    f_df_dpsi: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    ...
    j_parallel: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    ...
    r_inboard: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    r_outboard: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    ...
    dpsi_drho_tor: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    ...
    elongation: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    triangularity_upper: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    triangularity_lower: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    squareness_upper_inner: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    squareness_upper_outer: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    squareness_lower_inner: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    squareness_lower_outer: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    ...
    rho_volume_norm: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    dvolume_dpsi: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    dvolume_drho_tor: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    ...
    darea_dpsi: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    darea_drho_tor: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    ...
    trapped_fraction: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    gm1: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    gm2: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    gm3: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    gm4: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    gm5: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    gm6: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    gm7: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    gm8: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    gm9: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    b_average: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    b_field_average: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    b_min: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    b_field_min: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    b_max: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    b_field_max: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    ...
    mass_density: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
...
class EquilibriumProfiles2D(IdsBaseClass):
    ...
    :ivar type: Type of profiles (distinguishes contribution from
    ...
    j_tor: list[ndarray[(int,int), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    j_parallel: list[ndarray[(int,int), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    b_r: list[ndarray[(int,int), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    b_field_r: list[ndarray[(int,int), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    b_z: list[ndarray[(int,int), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    b_field_z: list[ndarray[(int,int), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    b_tor: list[ndarray[(int,int), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    b_field_tor: list[ndarray[(int,int), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
...
class EqulibriumGlobalQuantities(IdsBaseClass):
    ...
    beta_pol: float = field(
        default=9e+40
    )
    beta_tor: float = field(
        default=9e+40
    )
    beta_normal: float = field(
        default=9e+40
    )
    ip: float = field(
        default=9e+40
    ...
    length_pol: float = field(
        default=9e+40
    )
    psi_axis: float = field(
        default=9e+40
    )
    ...
    energy_mhd: float = field(
        default=9e+40
    )
    w_mhd: float = field(
        default=9e+40
    )
    psi_external_average: float = field(
        default=9e+40
    )
    v_external: float = field(
        default=9e+40
    )
    plasma_inductance: float = field(
        default=9e+40
    )
    plasma_resistance: float = field(
        default=9e+40
    )
...
class EquilibriumConstraints(IdsBaseClass):
    ...
    faraday_angle: list[EquilibriumConstraints0D] = field(
        default_factory=list
    )
    ...
    n_e: list[EquilibriumConstraints0D] = field(
        default_factory=list
    )
    n_e_line: list[EquilibriumConstraints0D] = field(
        default_factory=list
    )
    ...
    pressure: list[EquilibriumConstraints0D] = field(
        default_factory=list
    )
    q: list[EquilibriumConstraints0DPosition] = field(
        default_factory=list
    )
...
class EquilibriumGgd(IdsBaseClass):
    ...
    r: list[GenericGridScalar] = field(
        default_factory=list
    )
    z: list[GenericGridScalar] = field(
        default_factory=list
    )
    psi: list[GenericGridScalar] = field(
        default_factory=list
    )
    phi: list[GenericGridScalar] = field(
        default_factory=list
    )
    theta: list[GenericGridScalar] = field(
        default_factory=list
    )
    j_tor: list[GenericGridScalar] = field(
        default_factory=list
    )
    j_parallel: list[GenericGridScalar] = field(
        default_factory=list
    )
...
class EquilibriumGgdArray(IdsBaseClass):
    ...
    grid: list[GenericGridDynamic] = field(
        default_factory=list
    )
...
class EquilibriumTimeSlice(IdsBaseClass):
    ...
    boundary_secondary_separatrix: Optional[EquilibriumBoundarySecondSeparatrix] = field(
        default=None
    )
    ...
    profiles_2d: list[EquilibriumProfiles2D] = field(
        default_factory=list
    )
    ggd: list[EquilibriumGgd] = field(
        default_factory=list
    )
...
class Equilibrium(IdsBaseClass):
    ...
    grids_ggd: list[EquilibriumGgdArray] = field(
        default_factory=list
    )
    time_slice: list[EquilibriumTimeSlice] = field(
        default_factory=list
    )
