...
class PfCircuits(IdsBaseClass):
    ...
    connections: list[ndarray[(int, int), int]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
...
class PfForces(IdsBaseClass):
    ...
    combination: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    limit_max: float = field(
        default=9e+40
    )
    limit_min: float = field(
        default=9e+40
    )
...
class PfSupplies(IdsBaseClass):
    ...
    :ivar type: Type of the supply; TBD add free description of non-
    ...
    filter_numerator: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    filter_denominator: list[ndarray[(int,), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
    )
    current_limit_max: float = field(
        default=9e+40
    )
    current_limit_min: float = field(
        default=9e+40
    )
    voltage_limit_max: float = field(
        default=9e+40
    )
    voltage_limit_min: float = field(
        default=9e+40
    )
    current_limiter_gain: float = field(
        default=9e+40
    )
    energy_limit_max: float = field(
        default=9e+40
    )
    nonlinear_model: str = field(
        default=""
    )
    voltage: Optional[SignalFlt1D] = field(
        default=None
...
class PfCoils(IdsBaseClass):
    ...
    current_limit_max: list[ndarray[(int,int), float]] = field(
        default_factory=list,
        metadata={
            "max_occurs": 99,
        }
