...
class CustomerShopperImporter(VersionImporter):
    host_model_class = model.CustomerShopper

class CustomerShopperHistoryImporter(VersionImporter):
    host_model_class = model.CustomerShopperHistory
...
class MembershipTypeImporter(VersionImporter):
    host_model_class = model.MembershipType
