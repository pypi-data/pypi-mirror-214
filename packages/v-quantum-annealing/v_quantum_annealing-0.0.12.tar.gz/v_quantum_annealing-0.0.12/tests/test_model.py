...
class ModelTest(unittest.TestCase):
    ...
    def test_bqm_constructor(self):
        ...
        dense_graph,offset = bqm.get_cxxvqa_ising_graph()
    ...
    def test_transfer_to_cxxvqa(self):
        bqm = oj.BinaryQuadraticModel(self.h, self.J, 'SPIN', sparse=False)
        # to Dense
        ...
        #with offset
        bqm_qubo = oj.BinaryQuadraticModel.from_qubo(Q=self.Q)
        ising_graph,offset = bqm_qubo.get_cxxvqa_ising_graph()
    ...
    def test_energy_consistency(self):
        ...
        dense_ising_graph,offset = bqm.get_cxxvqa_ising_graph()
        bqm = oj.BinaryQuadraticModel(self.h, self.J, vartype='SPIN', sparse=True)
        sparse_ising_graph,offset = bqm.get_cxxvqa_ising_graph()
        spins = {0: -1, 1: -1, 2: -1, 3: -1}
