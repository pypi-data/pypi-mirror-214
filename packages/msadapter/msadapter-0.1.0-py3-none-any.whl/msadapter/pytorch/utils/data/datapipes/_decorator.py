...
from msadapter.pytorch.utils.data.datapipes.datapipe import IterDataPipe, MapDataPipe
from msadapter.pytorch.utils.data.datapipes._typing import _DataPipeMeta
