...
#
# import msadapter.pytorch.utils.data.backward_compatibility
#
# import msadapter.pytorch.utils.data.graph_settings
# from msadapter.pytorch.utils.data import DataLoader, IterDataPipe, communication
# from msadapter.pytorch.utils.data.datapipes.iter import IterableWrapper
#
# __all__ = [
#     "DataLoader2",
# ]
...
#             msadapter.pytorch.utils.data.graph_settings.apply_sharding(thread_localdatapipe, num_workers, worker_id)
#             thread.start()
...
#             datapipe = dataset
#             datapipe = msadapter.pytorch.utils.data.graph_settings.apply_shuffle_settings(datapipe, shuffle=shuffle)
...
#                         collate_fn = msadapter.pytorch.utils.data._utils.collate.default_collate
#
