...
# import msadapter.pytorch.utils.data.graph
# from msadapter.pytorch.utils.data.datapipes.iter import Shuffler
# import warnings
#
# __all__ = [
#     "apply_sharding",
...
#     graph = msadapter.pytorch.utils.data.graph.traverse(datapipe, only_datapipe=True)
