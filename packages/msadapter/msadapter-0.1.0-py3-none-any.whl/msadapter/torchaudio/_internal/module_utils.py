...
def _check_soundfile_importable():
    ...
    try:
        ...
        warnings.warn("Failed to import soundfile. 'soundfile' backend is not available. Please pip install soundfile.")
        return False
...
def is_sox_available():
    if not is_module_available("sox"):
        return False
    try:
        ...
        warnings.warn("Failed to import sox. 'sox' backend is not available. Please use command 'apt-get install sox' and 'pip install sox'.")
        return False
