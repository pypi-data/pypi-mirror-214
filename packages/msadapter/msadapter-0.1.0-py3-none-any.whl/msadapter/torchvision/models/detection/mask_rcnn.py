...
model_urls = {
    'maskrcnn_resnet50_fpn_coco':
        'maskrcnn_resnet50_fpn_coco-bf2d0c1e.ckpt',
}
...
def maskrcnn_resnet50_fpn(pretrained=False, progress=True,
    ...
    if pretrained:
        check_ckpt_file(model_urls['maskrcnn_resnet50_fpn_coco'])
        state_dict = torch.load(model_urls['maskrcnn_resnet50_fpn_coco'])
