...
from msadapter.torchvision.ops import MultiScaleRoIAlign
from msadapter import unsupported_attr
...
model_urls = {
    'fasterrcnn_resnet50_fpn_coco':'fasterrcnn_resnet50_fpn_coco-258fb6c6.ckpt',
    'fasterrcnn_mobilenet_v3_large_320_fpn_coco':'fasterrcnn_mobilenet_v3_large_320_fpn-907ea3f9.ckpt',
    'fasterrcnn_mobilenet_v3_large_fpn_coco':'fasterrcnn_mobilenet_v3_large_fpn-fb6a3cc7.ckpt'
}
...
def fasterrcnn_resnet50_fpn(pretrained=False, progress=True,
    ...
    if pretrained:
        check_ckpt_file(model_urls['fasterrcnn_resnet50_fpn_coco'])
        state_dict = torch.load(model_urls['fasterrcnn_resnet50_fpn_coco'])
