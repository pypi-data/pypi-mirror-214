...
f = {
    "mnasnet0_5":"mnasnet0.5_top1_67.823-3ffadce67e.ckpt",
    "mnasnet0_75": None,
    "mnasnet1_0":"mnasnet1.0_top1_73.512-f206786ef8.ckpt",
    "mnasnet1_3": None
}
...
def _load_pretrained(model_name: str, model: nn.Module, progress: bool) -> None:
    ...
    if model_name not in f or f[model_name] is None:
        raise ValueError(
            "No checkpoint is available for model type {}".format(model_name))
    model_url = f[model_name]
