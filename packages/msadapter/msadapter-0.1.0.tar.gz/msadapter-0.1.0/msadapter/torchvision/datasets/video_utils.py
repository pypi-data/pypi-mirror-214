...
from msadapter.torchvision.io import (
...
class VideoClips:
    ...
    def _compute_frame_pts(self) -> None:
        ...
        import msadapter.pytorch.utils.data

        dl: msadapter.pytorch.utils.data.DataLoader = msadapter.pytorch.utils.data.DataLoader(
    ...
    def get_clip(self, idx: int) -> Tuple[torch.Tensor, torch.Tensor, Dict[str, Any], int]:
        ...
        from msadapter.torchvision import get_video_backend
