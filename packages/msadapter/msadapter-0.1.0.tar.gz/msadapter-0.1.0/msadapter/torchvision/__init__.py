...
def set_video_backend(backend):
    ...
    if backend not in ["pyav"]:
        raise ValueError("Invalid video backend '%s'. Only support 'pyav' now." % backend)
