...
from msadapter.pytorch import nn, Tensor
...
model_urls = {
    'ssd300_vgg16_coco': 'ssd300_vgg16_coco-b556d3b4.ckpt',
}
...
backbone_urls = {
    ...
    'vgg16_features': 'vgg16_features-amdegroot.ckpt'
}
...
def _vgg_extractor(backbone_name: str, highres: bool, progress: bool, pretrained: bool, trainable_layers: int):
    if backbone_name in backbone_urls:
        ...
        if pretrained:
            check_ckpt_file(backbone_urls[backbone_name])
            state_dict = torch.load(backbone_urls[backbone_name])
