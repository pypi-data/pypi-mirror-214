...
from msadapter.pytorch.utils.data.datapipes._decorator import functional_datapipe
from msadapter.pytorch.utils.data._utils.collate import default_collate
from msadapter.pytorch.utils.data.datapipes.datapipe import IterDataPipe
from msadapter.pytorch.utils.data.datapipes.utils.common import _check_lambda_fn
...
class CollatorIterDataPipe(MapperIterDataPipe):
    ...
    By default, it uses :func:`msadapter.pytorch.utils.data.default_collate`.

    .. note::
        While writing a custom collate function, you can import :func:`msadapter.pytorch.utils.data.default_collate` for the
    ...
    Example: Convert integer data to float Tensor
        >>> class MyIterDataPipe(msadapter.pytorch.utils.data.IterDataPipe):
