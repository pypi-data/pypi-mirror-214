...
Refer to the Terraform Registory for docs: [`data_okta_domain`](https://registry.terraform.io/providers/okta/okta/4.0.1/docs/data-sources/domain).
'''
import abc
import builtins
import datetime
...
class DataOktaDomain(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/data-sources/domain okta_domain}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/data-sources/domain okta_domain} Data Source.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param domain_id_or_name: Brand ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/data-sources/domain#domain_id_or_name DataOktaDomain#domain_id_or_name}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
...
class DataOktaDomainConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def domain_id_or_name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/data-sources/domain#domain_id_or_name DataOktaDomain#domain_id_or_name}
        '''
