...
class DataOktaEmailCustomization(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/data-sources/email_customization okta_email_customization}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/data-sources/email_customization okta_email_customization} Data Source.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param brand_id: Brand ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/data-sources/email_customization#brand_id DataOktaEmailCustomization#brand_id}
        :param customization_id: The ID of the customization. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/data-sources/email_customization#customization_id DataOktaEmailCustomization#customization_id}
        :param template_name: Template Name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/data-sources/email_customization#template_name DataOktaEmailCustomization#template_name}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
...
class DataOktaEmailCustomizationConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def brand_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/data-sources/email_customization#brand_id DataOktaEmailCustomization#brand_id}
        '''
    ...
    def customization_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/data-sources/email_customization#customization_id DataOktaEmailCustomization#customization_id}
        '''
    ...
    def template_name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/data-sources/email_customization#template_name DataOktaEmailCustomization#template_name}
        '''
