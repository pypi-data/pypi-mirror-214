...
Refer to the Terraform Registory for docs: [`data_okta_theme`](https://registry.terraform.io/providers/okta/okta/4.0.1/docs/data-sources/theme).
'''
import abc
import builtins
import datetime
...
class DataOktaTheme(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/data-sources/theme okta_theme}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/data-sources/theme okta_theme} Data Source.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param brand_id: Brand ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/data-sources/theme#brand_id DataOktaTheme#brand_id}
        :param theme_id: Theme ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/data-sources/theme#theme_id DataOktaTheme#theme_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
...
class DataOktaThemeConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def brand_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/data-sources/theme#brand_id DataOktaTheme#brand_id}
        '''
    ...
    def theme_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.0.1/docs/data-sources/theme#theme_id DataOktaTheme#theme_id}
        '''
