...
class ClusterClusterWorkloadWithPrometheusMetric(object):
    ...
    openapi_types = {
        ...
        'pipelinestep_execution': 'ResponsePipelineStepExecution',
    ...
    attribute_map = {
        ...
        'pipelinestep_execution': 'pipelinestep_execution',
        'service': 'service',
        'status': 'status',
    ...
    def __init__(self, created_dt=None, experiment=None, id=None, kernel_cluster_node=None, kernel_resource_spec=None, metrics=None, model_service_revision=None, pipelinestep_execution=None, service=None, status=None, status_last_updated=None, type=None, workspace=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._pipelinestep_execution = None
        self._service = None
        self._status = None
        ...
        if pipelinestep_execution is not None:
            self.pipelinestep_execution = pipelinestep_execution
    ...
    @property
    def pipelinestep_execution(self):
        """Gets the pipelinestep_execution of this ClusterClusterWorkloadWithPrometheusMetric.  # noqa: E501


        :return: The pipelinestep_execution of this ClusterClusterWorkloadWithPrometheusMetric.  # noqa: E501
        :rtype: ResponsePipelineStepExecution
        """
        return self._pipelinestep_execution

    @pipelinestep_execution.setter
    def pipelinestep_execution(self, pipelinestep_execution):
        """Sets the pipelinestep_execution of this ClusterClusterWorkloadWithPrometheusMetric.


        :param pipelinestep_execution: The pipelinestep_execution of this ClusterClusterWorkloadWithPrometheusMetric.  # noqa: E501
        :type pipelinestep_execution: ResponsePipelineStepExecution
        """

        self._pipelinestep_execution = pipelinestep_execution
