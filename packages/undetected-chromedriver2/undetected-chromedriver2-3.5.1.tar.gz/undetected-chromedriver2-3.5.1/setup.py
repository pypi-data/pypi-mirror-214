...
with codecs.open(
    os.path.join(dirname, "undetected_chromedriver2", "__init__.py"),
    mode="r",
    encoding="utf-8",
) as fp:
    try:
...
setup(
    name="undetected-chromedriver2",
    version=version,
    packages=["undetected_chromedriver2"],
    install_requires=[
        "selenium>=4.9.0",
        "requests",
        "websockets",
    ],
    package_data={"undetected_chromedriver2": [os.path.join("example", "example.py")]},
    url="https://github.com/ultrafunkamsterdam/undetected-chromedriver",
    license="GPL-3.0",
    author="mlzboy",
    author_email="15268112200@163.com",
