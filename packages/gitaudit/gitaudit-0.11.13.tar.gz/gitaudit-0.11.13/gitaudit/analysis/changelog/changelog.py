...
from gitaudit.git.change_log_entry import ChangeLogEntry, SubmoduleUpdate
...
class GithubChangeLog:
    ...
    def get_change_log(  # noqa: C901
        ...
        start_iso_format = (
            changelog[-1].commit_date-timedelta(minutes=1)).isoformat()
        end_iso_format = (changelog[0].commit_date +
