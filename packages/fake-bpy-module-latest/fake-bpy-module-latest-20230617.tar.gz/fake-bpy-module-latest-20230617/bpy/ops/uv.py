...
def pack_islands(override_context: typing.
                 ...
                 *,
                 ...
                 pin: typing.Optional[typing.Any] = 'PACK',
    ...
    :param pin: Pinned Islands * ``PACK`` Pack -- Pinned islands are packed normally. * ``SCALE`` Lock Scale -- Pinned islands won't rescale. * ``ROTATION`` Lock Rotation -- Pinned islands won't rotate. * ``ROTATION_SCALE`` Lock Rotation and Scale -- Pinned islands will translate only. * ``LOCKED`` Lock in Place -- Pinned islands are locked in place. * ``IGNORE`` Ignore -- Pinned islands are not packed.
    :type pin: typing.Optional[typing.Any]
