...
def convert(override_context: typing.Union[typing.
    ...
    :type execution_context: typing.Union[str, int]
    :type undo: typing.Optional[bool]
    :param target: Target, Type of object to convert to * ``CURVE`` Curve -- Curve from Mesh or Text objects. * ``MESH`` Mesh -- Mesh from Curve, Surface, Metaball, Text, or Point Cloud objects. * ``GPENCIL`` Grease Pencil (legacy) -- Grease Pencil (legacy) from Curve or Mesh objects. * ``POINTCLOUD`` Point Cloud -- Point Cloud from Mesh objects. * ``CURVES`` Curves -- Curves from evaluated curve data. * ``GREASEPENCIL`` Grease Pencil -- Grease Pencil from Grease Pencil (legacy).
...
def grease_pencil_add(override_context: typing.
                      Union[typing.Dict, 'bpy.types.Context'] = None,
                      execution_context: typing.Union[str, int] = None,
                      undo: typing.Optional[bool] = None,
                      *,
