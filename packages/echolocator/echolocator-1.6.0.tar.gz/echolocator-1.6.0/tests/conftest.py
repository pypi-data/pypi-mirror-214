...
# from echolocator_lib.version import meta as version_meta
...
def logging_setup():
    ...
    logging.getLogger("luigi.echolocator_scheduler").setLevel("INFO")
    logging.getLogger("urllib3.connectionpool").setLevel("INFO")

    logging.getLogger("echolocator_lib.things").setLevel("INFO")

    # Messages about starting and stopping services.
    logging.getLogger("echolocator_lib.base_aiohttp").setLevel("INFO")

    # All echolocator database sql commands.
    # logging.getLogger("echolocator_lib.echolocator_databases.aiosqlite").setLevel("INFO")

    logging.getLogger("echolocator_lib.echolocator_contexts.classic").setLevel("INFO")
    logging.getLogger("echolocator_lib.echolocator_datafaces.context").setLevel("INFO")
