...
'''if __name__ == '__main__':
    azure_data_api = SGClimaSiteBlob(
        "sp=r&st=2023-05-28T18:17:08Z&se=2024-02-29T03:17:08Z&spr=https&sv=2022-11-02&sr=c&sig=lvF%2Fh4ncS83CngR0LBLtfyVEP%2F0abct5c9sR98jGYfc%3D",
        'sgc-datalake')
    ...
    async def main():
        ...
        print(end)
        await azure_data_api.download_site_data_async(64, start, end)
