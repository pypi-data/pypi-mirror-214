...
class DataUpcloudManagedDatabaseOpensearchIndices(
    ...
    def __init__(
        ...
        *,
        ...
        :param service: Service's UUID for which these indices belongs to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/upcloudltd/upcloud/2.11.0/docs/data-sources/managed_database_opensearch_indices#service DataUpcloudManagedDatabaseOpensearchIndices#service}
        ...
        :param indices: indices block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/upcloudltd/upcloud/2.11.0/docs/data-sources/managed_database_opensearch_indices#indices DataUpcloudManagedDatabaseOpensearchIndices#indices}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
...
class DataUpcloudManagedDatabaseOpensearchIndicesIndicesOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[DataUpcloudManagedDatabaseOpensearchIndicesIndices, _cdktf_9a9027ec.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[DataUpcloudManagedDatabaseOpensearchIndicesIndices, _cdktf_9a9027ec.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[DataUpcloudManagedDatabaseOpensearchIndicesIndices, _cdktf_9a9027ec.IResolvable]],
    ) -> None:
        if __debug__:
