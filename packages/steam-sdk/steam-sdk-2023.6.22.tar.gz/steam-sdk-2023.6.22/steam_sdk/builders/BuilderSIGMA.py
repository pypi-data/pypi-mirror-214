...
from steam_sdk.data.DataSIGMA import DataSIGMA, MultipoleRoxieGeometry, MultipoleSettings, MultipoleConductor
...
class BuilderSIGMA:
    ...
    def __init__(self,
        ...
        if flag_build:
            # Data structure
            self.data_SIGMA = DataSIGMA(magnet={'type': model_data.GeneralParameters.magnet_type})
            ...
            for cond in model_data.Conductors:
                ...
                if cond.cable.n_strands is None and cond.cable.type != "Mono":
            ...
            # --------- sources  ----------
            self.data_SIGMA.sources.bh_curve_source = model_data.Sources.BH_fromROXIE

            # --------- general params  ----------
            self.data_SIGMA.general_parameters.magnet_name = model_data.GeneralParameters.magnet_name
            self.data_SIGMA.general_parameters.T_initial = model_data.GeneralParameters.T_initial
            self.data_SIGMA.general_parameters.magnetic_length = model_data.GeneralParameters.magnetic_length
