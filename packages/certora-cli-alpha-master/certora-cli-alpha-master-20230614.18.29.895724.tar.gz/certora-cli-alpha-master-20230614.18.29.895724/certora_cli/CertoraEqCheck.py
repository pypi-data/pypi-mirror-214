...
class EquivalenceChecker:
    ...
    def run(self, args: argparse.Namespace) -> None:
        ...
        if self.functions[0] == self.functions[1] and \
            self.contracts[0] == self.contracts[1] and \
    ...
    def generate_conf_file(self, spec: Path) -> Path:
        ...
        if self.conf_mode:
            ...
            with (self.path / DEFAULT_CONF_PATH).open() as conf_file:
                ...
                if '--bitvector' in args:
                    contents['use_bitvector_theory'] = True
        ...
        if 'bitvector_theory' not in contents:
            logger.warning("WARNING: running without bitvector theory when using bitwise operations will result in \
                            inaccurate results \n Please run with --bitvector if you are using any of these operations.")
...
if __name__ == '__main__':
    parser = ArgumentParser(
        ...
        usage='python3 CertoraEqCheck.py def fileA:contractA:functionA:solcA fileB:contractB:functionB:solcB',
