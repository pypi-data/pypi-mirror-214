...
AUTH_RESTRICT_ADMINS = {'xnijel': {'trans.add_project', 'trans.change_project', 'trans.change_component', 'trans.add_component'}}  ###
...
CACHES = {'default': {'BACKEND': 'django_redis.cache.RedisCache', 'LOCATION': 'rediss://127.0.0.1:6378/0', 'OPTIONS': {'CONNECTION_POOL_KWARGS': {'ssl_cert_reqs': None}}}, 'avatar': {'BACKEND': 'django.core.cache.backends.filebased.FileBasedCache', 'LOCATION': '/home/nijel/weblate/weblate/data/avatar-cache', 'TIMEOUT': 86400, 'OPTIONS': {'MAX_ENTRIES': 1000}}}
CACHE_DIR = None  ###
...
COMPRESS_JINJA2_GET_ENVIRONMENT = <function CompressorConf.JINJA2_GET_ENVIRONMENT at 0x7fdee18a41f0>  ###
COMPRESS_MINT_DELAY = 30  ###
COMPRESS_MTIME_DELAY = 10  ###
COMPRESS_OFFLINE = False  ###
COMPRESS_OFFLINE_CONTEXT = [{'fonts_cdn_url': 'https://s.weblate.org/cdn/', 'STATIC_URL': '/static/', 'LANGUAGE_BIDI': True}, {'fonts_cdn_url': 'https://s.weblate.org/cdn/', 'STATIC_URL': '/static/', 'LANGUAGE_BIDI': False}]  ###
