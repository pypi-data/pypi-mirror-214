...
class ThunderHandler:
    ...
    def collect_metric(self):
        ...
        if(self._metric==Constant._AWS_CPS or self._metric==Constant._AZURE_CPS or self._metric==Constant._VMWARE_CPS):
            return self.collect_metric_cps()
        
        elif(self._metric==Constant._AWS_CPU or self._metric==Constant._AZURE_CPU or self._metric==Constant._VMWARE_CPU): 
            return self.collect_metric_cpu()
            
        elif(self._metric==Constant._AWS_MEMORY or self._metric==Constant._AZURE_MEMORY or self._metric==Constant._VMWARE_MEMORY):
            return self.collect_metric_memory()
        
        elif(self._metric==Constant._AWS_DISK or self._metric==Constant._AZURE_DISK or self._metric==Constant._VMWARE_DISK):
            return self.collect_metric_disk()
        
        elif(self._metric==Constant._AWS_THROUGHPUT or self._metric==Constant._AZURE_THROUGHPUT or self._metric==Constant._VMWARE_THROUGHPUT):
            return self.collect_metric_throughput()
        
        elif(self._metric==Constant._AWS_INTERFACES or self._metric==Constant._AZURE_INTERFACES or self._metric==Constant._VMWARE_INTERFACES):
            return self.collect_metric_interface()
        
        elif(self._metric==Constant._AWS_TPS or self._metric==Constant._AZURE_TPS or self._metric==Constant._VMWARE_TPS):
            return self.collect_metric_transaction()
        
        elif(self._metric==Constant._AWS_SERVER_DOWN_COUNT or self._metric==Constant._AZURE_SERVER_DOWN_COUNT or self._metric==Constant._VMWARE_SERVER_DOWN_COUNT):
            return self.collect_metric_server_down()
            
        elif(self._metric==Constant._AWS_SERVER_DOWN_PERCENTAGE or self._metric==Constant._AZURE_SERVER_DOWN_PERCENTAGE or self._metric==Constant._VMWARE_SERVER_DOWN_PERCENTAGE):
            return self.collect_metric_server_down_per()

        elif(self._metric==Constant._AWS_SSL_CERT or self._metric==Constant._AZURE_SSL_CERT  or self._metric==Constant._VMWARE_SSL_CERT ):
            return self.collect_metric_ssl()
        
        elif(self._metric==Constant._AWS_SERVER_ERROR or self._metric==Constant._AZURE_SERVER_ERROR or self._metric==Constant._VMWARE_SERVER_ERROR):
            return self.collect_metric_server_error()
            
        elif(self._metric==Constant._AWS_SESSION or self._metric==Constant._AZURE_SESSION or self._metric==Constant._VMWARE_SESSION):
            return self.collect_metric_session()
            
        elif(self._metric==Constant._AWS_PACKET_RATE or self._metric==Constant._AZURE_PACKET_RATE or self._metric==Constant._VMWARE_PACKET_RATE):
            return self.collect_metric_packet_rate()
            
        elif(self._metric==Constant._AWS_PACKET_DROP or self._metric==Constant._AZURE_PACKET_DROP or self._metric==Constant._VMWARE_PACKET_DROP):
