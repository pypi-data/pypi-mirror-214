...
from sunpeek.common.context import Context, sanitize_dataframe
...
class DataUploader_df:
    ...
    def do_upload(self, files, calculate_virtuals: bool = True):
...
class DataUploader_pq(DataUploader_df):
    ...
    def _post_upload(self):
        ...
        self.plant.context = Context(plant=self.plant, datasource='pq', eval_start=self.eval_start, eval_end=self.eval_end)
