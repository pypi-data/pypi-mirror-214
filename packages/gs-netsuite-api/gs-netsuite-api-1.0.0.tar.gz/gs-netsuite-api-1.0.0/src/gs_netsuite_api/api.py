...
class ProductAPI(BaseGsNetSuiteApi[ProductData]):
    ...
    def _convert_to_data(self, record) -> ProductData:
        ...
        product = ProductData(
            ...
            url_site="https://www.nvgallery.com/fr-fr/product/"
            + extract_custom_field(record, "custitemnv_master_reference"),
            ...
            images=extract_custom_field(record, "custitemnvg_image_url_text")
            or "https://www.nvgallery.com/fr-fr/product/vignette/" + record.itemId,
        )
        return product
