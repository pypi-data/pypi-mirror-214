...
class JwtTokenDTO(BaseModel):
    ...
    __properties = ["jwtToken", "expirationDate", "refreshToken"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JwtTokenDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JwtTokenDTO:
        """Create an instance of JwtTokenDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JwtTokenDTO.parse_obj(obj)
