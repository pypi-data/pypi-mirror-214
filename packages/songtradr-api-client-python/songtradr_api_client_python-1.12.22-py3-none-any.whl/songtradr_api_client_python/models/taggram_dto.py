...
class TaggramDTO(BaseModel):
    ...
    """
    timeseries: conlist(Union[StrictFloat, StrictInt]) = Field(..., description="Values represent the strength of presence of the corresponding category, tag or genre.")
    ...
    __properties = ["timeseries", "categoryName", "tagName", "genreName", "scale"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaggramDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaggramDTO:
        """Create an instance of TaggramDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaggramDTO.parse_obj(obj)

        _obj = TaggramDTO.parse_obj({
