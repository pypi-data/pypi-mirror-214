...
class SaveRecordingGenreDTO(BaseModel):
    """
    ...
    affinity: Optional[Union[StrictFloat, StrictInt]] = None
    __properties = ["genreName", "genreType", "affinity"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SaveRecordingGenreDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SaveRecordingGenreDTO:
        """Create an instance of SaveRecordingGenreDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SaveRecordingGenreDTO.parse_obj(obj)
