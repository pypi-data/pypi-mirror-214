...
class FileMinimalWithUrlDTO(BaseModel):
    """
    ...
    __properties = ["fileName", "url", "isrc"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileMinimalWithUrlDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FileMinimalWithUrlDTO:
        """Create an instance of FileMinimalWithUrlDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileMinimalWithUrlDTO.parse_obj(obj)
