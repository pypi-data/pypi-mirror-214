...
class ConfigIdentifierDTO(BaseModel):
    ...
    __properties = ["identifierType", "identifierValue"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigIdentifierDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigIdentifierDTO:
        """Create an instance of ConfigIdentifierDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigIdentifierDTO.parse_obj(obj)
