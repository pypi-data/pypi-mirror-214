...
class RecordingForSimilaritySearchDTO(BaseModel):
    ...
    """
    recording: RecordingSmallDTO = Field(...)
    score: Union[StrictFloat, StrictInt] = Field(...)
    __properties = ["recording", "score"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecordingForSimilaritySearchDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecordingForSimilaritySearchDTO:
        """Create an instance of RecordingForSimilaritySearchDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RecordingForSimilaritySearchDTO.parse_obj(obj)
