...
class ErrorResponse(BaseModel):
    ...
    message: Optional[StrictStr] = Field(None, description="detailed error message")
    path: Optional[StrictStr] = Field(None, description="path of the called API endpoint")
    __properties = ["timestamp", "status", "error", "message", "path"]
