...
class TrackToMediumProductDTO(BaseModel):
    """
    A track that connects from recording to a product with a mid-sized field set.
    """
    track_no: StrictStr = Field(..., alias="trackNo")
    set_no: Optional[StrictStr] = Field(None, alias="setNo")
    product: ProductMediumDTO = Field(...)
    __properties = ["trackNo", "setNo", "product"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrackToMediumProductDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrackToMediumProductDTO:
        """Create an instance of TrackToMediumProductDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrackToMediumProductDTO.parse_obj(obj)
