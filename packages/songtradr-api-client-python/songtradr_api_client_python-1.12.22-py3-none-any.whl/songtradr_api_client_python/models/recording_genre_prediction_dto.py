...
class RecordingGenrePredictionDTO(BaseModel):
    ...
    genre: GenreMinimalDTO = Field(...)
    probability: Union[StrictFloat, StrictInt] = Field(...)
    __properties = ["genreType", "genre", "probability"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecordingGenrePredictionDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecordingGenrePredictionDTO:
        """Create an instance of RecordingGenrePredictionDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RecordingGenrePredictionDTO.parse_obj(obj)
