...
class SaveRecordingTagDTO(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SaveRecordingTagDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SaveRecordingTagDTO:
        """Create an instance of SaveRecordingTagDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SaveRecordingTagDTO.parse_obj(obj)
