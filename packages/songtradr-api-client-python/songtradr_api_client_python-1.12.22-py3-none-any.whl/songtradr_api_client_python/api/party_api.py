...
class PartyApi(object):
    ...
    @validate_arguments
    def party(self, full_name : Annotated[StrictStr, Field(..., description="Full Name of the person, group, company or organisation.")], **kwargs) -> PartyLargeDTO:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the party_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.party_with_http_info(full_name, **kwargs)  # noqa: E501

    @validate_arguments
    def party_with_http_info(self, full_name : Annotated[StrictStr, Field(..., description="Full Name of the person, group, company or organisation.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Information on a person, group or company.  # noqa: E501
