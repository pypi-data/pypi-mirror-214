...
class AllowedValuesApi(object):
    ...
    @validate_arguments
    def allowed_musical_features(self, response_size : Annotated[Optional[StrictStr], Field(description="Size the response should have.")] = None, **kwargs) -> SearchFilterValuesDTO:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the allowed_musical_features_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.allowed_musical_features_with_http_info(response_size, **kwargs)  # noqa: E501

    @validate_arguments
    def allowed_musical_features_with_http_info(self, response_size : Annotated[Optional[StrictStr], Field(description="Size the response should have.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Allowed values for music descriptive parameters to be used in the searchAll endpoint.  # noqa: E501
    ...
    @validate_arguments
    def tags(self, category_name : Annotated[Optional[StrictStr], Field(description="Filters tags for one category only ")] = None, **kwargs) -> List[CategoryMediumDTO]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the tags_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.tags_with_http_info(category_name, **kwargs)  # noqa: E501

    @validate_arguments
    def tags_with_http_info(self, category_name : Annotated[Optional[StrictStr], Field(description="Filters tags for one category only ")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """(Deprecated) All descriptive tags inside of tag-categories.  # noqa: E501
