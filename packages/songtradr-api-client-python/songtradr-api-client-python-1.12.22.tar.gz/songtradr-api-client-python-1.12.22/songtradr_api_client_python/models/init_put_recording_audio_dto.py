...
class InitPutRecordingAudioDTO(BaseModel):
    ...
    object_key: Optional[StrictStr] = Field(None, alias="objectKey")
    url: Optional[StrictStr] = None
    __properties = ["isrc", "objectKey", "url"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InitPutRecordingAudioDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InitPutRecordingAudioDTO:
        """Create an instance of InitPutRecordingAudioDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InitPutRecordingAudioDTO.parse_obj(obj)
