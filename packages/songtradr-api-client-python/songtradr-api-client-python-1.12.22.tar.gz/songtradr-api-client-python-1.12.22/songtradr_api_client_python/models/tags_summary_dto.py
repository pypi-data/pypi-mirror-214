...
class TagsSummaryDTO(BaseModel):
    ...
    __properties = ["name", "categories", "total"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TagsSummaryDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TagsSummaryDTO:
        """Create an instance of TagsSummaryDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TagsSummaryDTO.parse_obj(obj)
