...
class ConfigAccessDTO(BaseModel):
    ...
    """
    accessor_id: StrictStr = Field(..., alias="accessorId", description="ID of the accessing entity")
    rights: StrictStr = Field(..., description="access rights to a resource")
    __properties = ["accessorId", "rights"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigAccessDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigAccessDTO:
        """Create an instance of ConfigAccessDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigAccessDTO.parse_obj(obj)
