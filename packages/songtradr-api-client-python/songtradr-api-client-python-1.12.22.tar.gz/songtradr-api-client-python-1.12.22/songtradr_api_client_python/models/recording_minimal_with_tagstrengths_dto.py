...
class RecordingMinimalWithTagstrengthsDTO(BaseModel):
    ...
    tagstrengths: Optional[conlist(TagstrengthDTO)] = None
    __properties = ["isrc", "tagstrengths"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecordingMinimalWithTagstrengthsDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecordingMinimalWithTagstrengthsDTO:
        """Create an instance of RecordingMinimalWithTagstrengthsDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RecordingMinimalWithTagstrengthsDTO.parse_obj(obj)
