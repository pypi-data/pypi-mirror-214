...
class SaveUserDTO(BaseModel):
    ...
    language: Optional[StrictStr] = Field(None, description="Current status of the recording.")
    __properties = ["system", "emailAddress", "password", "fullName", "companyName", "language"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SaveUserDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SaveUserDTO:
        """Create an instance of SaveUserDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SaveUserDTO.parse_obj(obj)

        _obj = SaveUserDTO.parse_obj({
