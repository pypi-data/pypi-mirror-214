...
class SearchRecordingGranularDTO(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SearchRecordingGranularDTO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SearchRecordingGranularDTO:
        """Create an instance of SearchRecordingGranularDTO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SearchRecordingGranularDTO.parse_obj(obj)
