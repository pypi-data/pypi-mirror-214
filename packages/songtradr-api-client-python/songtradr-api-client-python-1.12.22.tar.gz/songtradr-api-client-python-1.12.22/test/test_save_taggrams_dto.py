...
from songtradr_api_client_python.models.save_taggrams_dto import SaveTaggramsDTO  # noqa: E501
from songtradr_api_client_python.rest import ApiException

class TestSaveTaggramsDTO(unittest.TestCase):
    """SaveTaggramsDTO unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SaveTaggramsDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SaveTaggramsDTO`
        """
        model = songtradr_api_client_python.models.save_taggrams_dto.SaveTaggramsDTO()  # noqa: E501
        if include_optional :
