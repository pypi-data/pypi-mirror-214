...
from songtradr_api_client_python.models.save_playlist_dto import SavePlaylistDTO  # noqa: E501
from songtradr_api_client_python.rest import ApiException

class TestSavePlaylistDTO(unittest.TestCase):
    """SavePlaylistDTO unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SavePlaylistDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SavePlaylistDTO`
        """
        model = songtradr_api_client_python.models.save_playlist_dto.SavePlaylistDTO()  # noqa: E501
        if include_optional :
            return SavePlaylistDTO(
                ...
                recordings = [
                    songtradr_api_client_python.models.save_recording_playlist_dto.SaveRecordingPlaylistDTO(
