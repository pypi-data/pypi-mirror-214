...
class TestUserApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = songtradr_api_client_python.api.user_api.UserApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_create_user_referrer(self):
    ...
    def test_initiate_user_file_upload(self):
    ...
    def test_recordings_by_folder_with_taggrams(self):
    ...
    def test_recordings_by_folder_with_tagstrengths(self):
    ...
    def test_update_user_file_recording(self):
    ...
    def test_user_files_download(self):
    ...
    def test_user_files_status(self):
    ...
    def test_user_files_summary(self):
