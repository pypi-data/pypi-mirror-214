...
import six
from fabric_cf.orchestrator.swagger_client.models.status200_ok_single import Status200OkSingle  # noqa: F401,E501

class SliceDetails(Status200OkSingle):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SliceDetails, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SliceDetails):
            return False
