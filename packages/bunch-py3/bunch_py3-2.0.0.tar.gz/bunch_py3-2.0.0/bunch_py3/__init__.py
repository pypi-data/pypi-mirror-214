...
class Bunch(dict):
    """ A dictionary that provides attribute-style access.
        ...
        >>> [ (k,b[k]) for k in b ]
        [('hello', 42), ('foo', Bunch(lol=True)), ('ponies', 'are pretty!')]
    ...
    def toDict(self):
        """ Recursively converts a bunch back into a dictionary.
            ...
            >>> b = Bunch(ponies='are pretty!', foo=Bunch(lol=True), hello=42)
            >>> b.toDict()
...
def unbunchify(x):
    """ Recursively converts a Bunch into a dictionary.
        ...
        >>> b = Bunch(ponies=('are pretty!', Bunch(lies='are trouble!')), foo=['bar', Bunch(lol=True)], hello=42, 
        ...         )
...
try:
    ...
    def from_yaml(loader, node):
        """ PyYAML support for Bunches using the tag `!bunch` and `!bunch.Bunch`.
            ...
            ...   Brian : Ingerson
            ...   Oren  : Ben-Kiki
            ... ''', yaml.Loader) #doctest: +NORMALIZE_WHITESPACE
