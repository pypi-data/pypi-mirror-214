...
def upsert_from_path(
    ...
    if set_row_creation_time:
        rct_cols = {m.metric_metadata.dataset_time_column_name for m in mil.metrics if m.metric_metadata.dataset_time_column_name} 
        client.set_table_metric_times(
            column_names=rct_cols,
        ...
        try:
            ...
            if update_collections:
                for c in m.collections:
                    client.upsert_metric_to_collection(collection_id=c.id,add_metric_ids=[rmc.id])
