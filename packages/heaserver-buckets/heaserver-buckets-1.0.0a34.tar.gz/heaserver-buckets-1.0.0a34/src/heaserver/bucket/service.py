...
from heaobject.folder import AWSS3BucketItem, Folder, AWSS3Folder, AWSS3FolderFileItem
...
async def get_all_buckets(request: web.Request) -> web.Response:
    ...
    activity.description = 'Getting all buckets'
...
async def get_all_bucketitems(request: web.Request) -> web.Response:
    ...
    activity.owner = request.headers.get(SUB)
    activity.user_id = activity.owner
    activity.description = f'Listing all buckets'
    await publish_desktop_object(request.app, activity)
...
async def put_bucket(request: web.Request) -> web.Response:
    ...
    activity.owner = request.headers.get(SUB)
    activity.user_id = activity.owner
    activity.description = f'Updating {bucket_name}'
    await publish_desktop_object(request.app, activity)
...
async def delete_bucket(request: web.Request) -> web.Response:
    ...
    activity.owner = request.headers.get(SUB)
    activity.user_id = activity.owner
    activity.description = f'Deleting {bucket_id}'
    await publish_desktop_object(request.app, activity)
...
async def _get_bucket(request: web.Request) -> web.Response:
    ...
    activity.owner = request.headers.get(SUB)
    activity.user_id = activity.owner
    activity.description = f'Getting {bucket_name}'
    await publish_desktop_object(request.app, activity)
