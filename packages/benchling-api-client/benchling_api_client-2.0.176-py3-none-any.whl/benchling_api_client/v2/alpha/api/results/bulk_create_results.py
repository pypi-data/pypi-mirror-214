...
from ...models.results_bulk_create_request import ResultsBulkCreateRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: ResultsBulkCreateRequest,
) -> Dict[str, Any]:
    url = "{}/results:bulk-create".format(client.base_url)
