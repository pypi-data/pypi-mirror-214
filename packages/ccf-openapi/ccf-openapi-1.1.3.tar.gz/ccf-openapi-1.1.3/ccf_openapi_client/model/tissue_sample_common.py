...
class TissueSampleCommon(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, sample_type, datasets, *args, **kwargs):  # noqa: E501
        """TissueSampleCommon - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, sample_type, datasets, *args, **kwargs):  # noqa: E501
        """TissueSampleCommon - a model defined in OpenAPI
