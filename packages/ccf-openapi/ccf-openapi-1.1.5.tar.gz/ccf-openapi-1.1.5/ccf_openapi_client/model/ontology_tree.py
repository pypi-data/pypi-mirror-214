...
class OntologyTree(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'root': (str,),  # noqa: E501
            'nodes': ({str: (OntologyTreeNode,)},),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, root, nodes, *args, **kwargs):  # noqa: E501
        """OntologyTree - a model defined in OpenAPI

        Args:
            root (str): Reference to the root node.
            nodes ({str: (OntologyTreeNode,)}): A mapping of identifiers to each node object.
    ...
    @convert_js_args_to_python_args
    def __init__(self, root, nodes, *args, **kwargs):  # noqa: E501
        """OntologyTree - a model defined in OpenAPI
