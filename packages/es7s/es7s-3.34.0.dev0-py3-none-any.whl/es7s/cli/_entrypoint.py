...
from .config import group as config_group
from .exec_ import group as execute_group
from .manage import group as manage_group
from .print import group as print_group
from .monitor._group import group as monitor_group
from .help_ import group as help_group
