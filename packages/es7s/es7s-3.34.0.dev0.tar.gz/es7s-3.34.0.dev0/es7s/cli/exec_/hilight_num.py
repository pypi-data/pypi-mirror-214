...
from .._decorators import cli_pass_context, _catch_and_log_and_exit, cli_option, cli_argument, \
    cli_command
from ...shared import get_stdout, get_logger, DemoHilightNumText, FrozenStyle
...
class HighlightNumbersCommand:
    ...
    def __init__(self, ctx: click.Context, file: click.File | None, example: bool, **kwargs):
        self._line_num = 1
        self._offset = 0
