...
class Calib(object):
    ...
    POC = property(_PaIRS_PIV.Calib_POC_get, _PaIRS_PIV.Calib_POC_set)
...
class CalibOut(object):
    ...
    X = property(_PaIRS_PIV.CalibOut_X_get, _PaIRS_PIV.CalibOut_X_set)
    Y = property(_PaIRS_PIV.CalibOut_Y_get, _PaIRS_PIV.CalibOut_Y_set)
    x = property(_PaIRS_PIV.CalibOut_x_get, _PaIRS_PIV.CalibOut_x_set)
    y = property(_PaIRS_PIV.CalibOut_y_get, _PaIRS_PIV.CalibOut_y_set)
    flag = property(_PaIRS_PIV.CalibOut_flag_get, _PaIRS_PIV.CalibOut_flag_set)
...
class Cal(object):
    ...
    tipoCalMASK = property(_PaIRS_PIV.Cal_tipoCalMASK_get)
    tipoCalSHIFT = property(_PaIRS_PIV.Cal_tipoCalSHIFT_get)
    tipoCalSHIFT_CYL = property(_PaIRS_PIV.Cal_tipoCalSHIFT_CYL_get)
    tipoCalSHIFT_PH = property(_PaIRS_PIV.Cal_tipoCalSHIFT_PH_get)
    tipoCalSHIFT_PAR = property(_PaIRS_PIV.Cal_tipoCalSHIFT_PAR_get)
    tipoCalNORMALE = property(_PaIRS_PIV.Cal_tipoCalNORMALE_get)
    tipoCalPER_PIANI = property(_PaIRS_PIV.Cal_tipoCalPER_PIANI_get)
    tipoCalSOLOPIANO = property(_PaIRS_PIV.Cal_tipoCalSOLOPIANO_get)
    tipoCalCYL = property(_PaIRS_PIV.Cal_tipoCalCYL_get)
    tipoCalSELFCAL = property(_PaIRS_PIV.Cal_tipoCalSELFCAL_get)
    ...
    def getFlagPlane(self, plane):
        return _PaIRS_PIV.Cal_getFlagPlane(self, plane)

    def setOriginFound(self, p, flag):
        return _PaIRS_PIV.Cal_setOriginFound(self, p, flag)

    def setPlaneFound(self, p, flag):
        return _PaIRS_PIV.Cal_setPlaneFound(self, p, flag)

    def originFound(self, p):
        return _PaIRS_PIV.Cal_originFound(self, p)

    def sizeOut(self, plane):
        return _PaIRS_PIV.Cal_sizeOut(self, plane)
    flagOper = property(_PaIRS_PIV.Cal_flagOper_get, _PaIRS_PIV.Cal_flagOper_set)
