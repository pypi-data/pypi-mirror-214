...
def make_arg(model_name, inference_col_name, embedding_col_name):
    return [
        {"displayColumnName": inference_col_name, "type": "inference", "model": model_name, "ref_col_name": ""},
        {"displayColumnName": embedding_col_name, "type": "imageEmbedding", "model": model_name, "ref_col_name": ""}
    ]
...
def upload_file(pre_signed_url, file_path, success_callback=None, failure_callback=None):
    ...
    print(f"PRE_SIGNED-URL: {pre_signed_url}")
