...
from src.ens_sdk.utils.decouple import config
from src.ens_sdk.utils.cache import Cache
from src.ens_sdk.utils.timezone import make_aware
...
class ENS:
    ...
    def _send(self, endpoint: str, headers: dict = None, payload: dict = None, method: str = 'post', authenticate: bool = False):
        ...
        request = requests.Request(
            method=method,
            url=f'{self._ENS_SERVER}{endpoint}',
            **payload,
            headers=headers
        )
        try:
