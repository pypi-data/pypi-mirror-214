...
from modelbit.autologin import mbApi as _mbApi, mbApiReadOnly
...
def add_job(
  ...
  """
  return m_jobs.add_job(func, deployment_name, name, store_result_as, python_version, python_packages,
                        system_packages, extra_files, redeploy_on_success, email_on_failure, schedule,
                        refresh_datasets, size, timeout_minutes, default_arguments)
