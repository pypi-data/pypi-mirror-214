...
from hestia_earth.models.emepEea2019.n2OToAirFuelCombustionDirect import TERM_ID, run, _should_run

class_path = f"hestia_earth.models.emepEea2019.{TERM_ID}"
fixtures_folder = f"{fixtures_path}/emepEea2019/{TERM_ID}"
TERMS = [
    'diesel'
]
...
@patch('hestia_earth.models.emepEea2019.utils.get_liquid_fuel_terms', return_value=TERMS)
