...
class IfcChecker(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (int,),  # noqa: E501
            'ifc': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'creator': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'results': ([CheckerResult],),  # noqa: E501
            'created_at': (datetime,),  # noqa: E501
            'updated_at': (datetime,),  # noqa: E501
            'checkplan': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, ifc, creator, results, created_at, updated_at, checkplan, *args, **kwargs):  # noqa: E501
        """IfcChecker - a model defined in OpenAPI

        Args:
            id (int):
            ifc (bool, date, datetime, dict, float, int, list, str, none_type):
            creator (bool, date, datetime, dict, float, int, list, str, none_type):
            results ([CheckerResult]):
            created_at (datetime):
            updated_at (datetime):
            checkplan (bool, date, datetime, dict, float, int, list, str, none_type):
