...
class Requirements(object):
    ...
    def get():
        ...
        :return:
        """
        requirements = ["nanoid==2.0.0", "kazoo==2.9.0"]
        return requirements
...
version_prod='0.1.11'  # Giữ nguyên định dạng không được format file có khoảng trống theo Pycharm (version_dev = '1.0.9' là file run.sh sẽ không bắt được current_version)
...
setup(
    ...
    version='0.1.11',  # Required, Phần này cũng không được format file.
    ...
    # larger catalog.
    keywords="mobio, scheduler, partitioning",  # Optional
