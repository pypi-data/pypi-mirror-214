...
class TecUtilConnector(object):
    ...
    def load_linux(self):
        ...
        msg = dedent('''\
            The Tecplot batch library or one of it’s dependencies could not be 
            found. This is usually the result of an incorrect environment setup. 
    ...
    def load_darwin(self):
        ...
        msg = dedent('''\
            ...
            On Apple Silicon machines, install and try using an intel only 
            version of python:
                tec360-env – python3-intel64 [options]
    ...
    def start(self):
        ...
        if self.handle is None:
            try:
                ...
                log.error(e)
                self._load_library_error = TecplotOutOfDateEngineError, (2020, 1, 0)
