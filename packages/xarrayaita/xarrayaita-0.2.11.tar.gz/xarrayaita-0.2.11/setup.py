...
URL = 'https://gricad-gitlab.univ-grenoble-alpes.fr/mecaiceige/tools/lib_python/xarray_aita'
...
REQUIRED = [
    'xarray','numpy','matplotlib','scikit-image','scipy','ipywidgets','datetime','tqdm','pandas','vtk', 'mahotas','ipympl','nodejs','jupyterlab','xarrayuvecs',
]
