...
from wow_ai_cv.dataset.ultils import approximate_mask_with_polygons
from wow_ai_cv.detection.core import Detections
from wow_ai_cv.detection.utils import polygon_to_mask, polygon_to_xyxy
from wow_ai_cv.utils.file import (
...
def save_coco_annotations(
    ...
    for image_name, image in images.items():
        ...
        coco_annotations_name = _image_name_to_annotation_name(image_name=image_name)
        coco_annotations_path = os.path.join(
            annotations_directory_path, coco_annotations_name
        )
        lines = detections_to_coco_annotations(
            detections=detections,
        ...
        save_text_file(lines=lines, file_path=coco_annotations_path)
