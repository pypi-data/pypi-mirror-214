...
from wow_ai_cv.geometry.core import Position
from wow_ai_cv.utils.internal import deprecated
...
class Detections:
    ...
    def from_roboflow(cls, roboflow_result: dict, class_list: List[str]) -> Detections:
        """
        Create a Detections object from the [Roboflow](https://wow-ai.com/) API inference result.
    ...
    @classmethod
    @deprecated(
        "Dataset loading and saving is going to be executed by wow_ai_cv.dataset.core.Dataset"
    )
    ...
    def empty(cls) -> Detections:
        ...
        Example:
            ```python
            >>> from wow_ai_cv import Detections
