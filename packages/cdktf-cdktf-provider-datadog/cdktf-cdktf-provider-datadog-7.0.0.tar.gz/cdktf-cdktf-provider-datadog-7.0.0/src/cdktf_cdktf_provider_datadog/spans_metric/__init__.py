...
class SpansMetric(
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.26.0/docs/resources/spans_metric datadog_spans_metric} Resource.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param name: The name of the span-based metric. This field can't be updated after creation. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.26.0/docs/resources/spans_metric#name SpansMetric#name}
        :param filter: filter block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.26.0/docs/resources/spans_metric#filter SpansMetric#filter}
        :param group_by: group_by block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.26.0/docs/resources/spans_metric#group_by SpansMetric#group_by}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def put_filter(self, *, query: typing.Optional[builtins.str] = None) -> None:
        '''
        :param query: The search query - following the span search syntax. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.26.0/docs/resources/spans_metric#query SpansMetric#query}
        '''
    ...
    def filter_input(
        self,
    ) -> typing.Optional[typing.Union["SpansMetricFilter", _cdktf_9a9027ec.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["SpansMetricFilter", _cdktf_9a9027ec.IResolvable]], jsii.get(self, "filterInput"))
...
class SpansMetricCompute:
    def __init__(
        ...
        *,
        ...
        '''
        :param aggregation_type: The type of aggregation to use. This field can't be updated after creation. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.26.0/docs/resources/spans_metric#aggregation_type SpansMetric#aggregation_type}
        :param include_percentiles: Toggle to include or exclude percentile aggregations for distribution metrics. Only present when the ``aggregation_type`` is ``distribution``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.26.0/docs/resources/spans_metric#include_percentiles SpansMetric#include_percentiles}
        :param path: The path to the value the span-based metric will aggregate on (only used if the aggregation type is a "distribution"). This field can't be updated after creation. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.26.0/docs/resources/spans_metric#path SpansMetric#path}
        '''
        if __debug__:
...
class SpansMetricComputeOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[SpansMetricCompute, _cdktf_9a9027ec.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[SpansMetricCompute, _cdktf_9a9027ec.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[SpansMetricCompute, _cdktf_9a9027ec.IResolvable]],
    ) -> None:
        if __debug__:
...
class SpansMetricFilterOutputReference(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[SpansMetricFilter, _cdktf_9a9027ec.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[SpansMetricFilter, _cdktf_9a9027ec.IResolvable]],
    ) -> None:
        if __debug__:
...
class SpansMetricGroupBy:
    def __init__(
        ...
        *,
        ...
        '''
        :param path: The path to the value the span-based metric will be aggregated over. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.26.0/docs/resources/spans_metric#path SpansMetric#path}
        :param tag_name: Eventual name of the tag that gets created. By default, the path attribute is used as the tag name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.26.0/docs/resources/spans_metric#tag_name SpansMetric#tag_name}
        '''
        if __debug__:
...
class SpansMetricGroupByOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[SpansMetricGroupBy, _cdktf_9a9027ec.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[SpansMetricGroupBy, _cdktf_9a9027ec.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[SpansMetricGroupBy, _cdktf_9a9027ec.IResolvable]],
    ) -> None:
        if __debug__:
