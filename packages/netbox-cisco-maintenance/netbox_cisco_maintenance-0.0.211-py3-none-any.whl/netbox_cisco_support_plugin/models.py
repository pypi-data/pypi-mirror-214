...
class CiscoDeviceTypeSupport(ChangeLoggedModel):
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_cisco_support_plugin:ciscodevicetypesupport_list", args=[self.pk])
...
class CiscoDeviceSupport(ChangeLoggedModel):
    ...
    def get_absolute_url(self):
        return reverse("plugins:netbox_cisco_support_plugin:ciscodevicesupport_list", args=[self.pk])
