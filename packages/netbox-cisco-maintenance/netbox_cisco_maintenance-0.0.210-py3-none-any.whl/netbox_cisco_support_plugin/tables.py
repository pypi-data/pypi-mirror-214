...
class CiscoDeviceSupportTable(NetBoxTable):
    ...
    class Meta(NetBoxTable.Meta):
        ...
        # fmt: off
        fields = (
            "pk", "device", "serial", "recommended_release", "desired_release", "current_release",
        ...
        default_columns = (
            "pk", "device", "desired_release_status", "desired_release", "current_release_status",
...
class CiscoDeviceTypeSupportTable(NetBoxTable):
    ...
    class Meta(NetBoxTable.Meta):
        ...
        # fmt: off
        fields = (
            "pk", "device_type", "eox_has_error", "eox_announcement_date", "end_of_sale_date",
            "end_of_sw_maintenance_releases", "end_of_security_vul_support_date",
            "end_of_routine_failure_analysis_date", "end_of_service_contract_renewal",
            "last_date_of_support", "end_of_svc_attach_date",
        )
        default_columns = (
            "pk", "device_type", "eox_has_error", "eox_error", "eox_announcement_date", "end_of_sale_date",
            "end_of_sw_maintenance_releases", "end_of_security_vul_support_date",
            "end_of_routine_failure_analysis_date", "end_of_service_contract_renewal",
            "last_date_of_support", "end_of_svc_attach_date",
        )
