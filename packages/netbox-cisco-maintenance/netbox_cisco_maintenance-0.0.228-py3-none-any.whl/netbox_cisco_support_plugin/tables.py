...
class CiscoDeviceSupportTable(NetBoxTable):
    ...
    class Meta(NetBoxTable.Meta):
        ...
        # fmt: off
        fields = (
            "pk", "id", "device", "device_type", "serial", "recommended_release", "desired_release", "current_release",
...
class CiscoDeviceTypeSupportTable(NetBoxTable):
    ...
    class Meta(NetBoxTable.Meta):
        ...
        # fmt: off
        fields = (
            "pk", "id", "device_type", "eox_has_error", "eox_announcement_date", "end_of_sale_date",
