...
class CiscoDeviceTypeSupportSerializer(NetBoxModelSerializer):
    ...
    class Meta:
        ...
        # fmt: off
        fields = [
            "id", "url", "display", "device_type", "eox_has_error", "eox_error", "eox_announcement_date",
            ...
            "end_of_svc_attach_date", "tags", "custom_fields", "created", "last_updated",
        ]
        # fmt: on
...
class CiscoDeviceSupportSerializer(NetBoxModelSerializer):
    ...
    class Meta:
        ...
        # fmt: off
        fields = [
            "id", "url", "display", "device", "model", "serial", "api_status", "sr_no_owner", "is_covered",
            ...
            "end_of_service_contract_renewal", "last_date_of_support", "end_of_svc_attach_date", "tags",
