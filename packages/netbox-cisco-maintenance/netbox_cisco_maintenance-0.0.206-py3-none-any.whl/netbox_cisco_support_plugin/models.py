...
class CiscoDeviceSupport(ChangeLoggedModel):
    ...
    service_contract_number = models.CharField(max_length=100, blank=True, null=True, verbose_name="Contract Number")
    ...
    contract_supplier = models.CharField(max_length=100, blank=True, null=True, verbose_name="Contract Supplier")

    api_status = models.CharField(max_length=100, blank=True, null=True, verbose_name="API Status")

    recommended_release = models.CharField(max_length=100, blank=True, null=True, verbose_name="Recommended Release")
