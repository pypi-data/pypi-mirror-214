...
class CiscoDeviceSupportTable(NetBoxTable):
    ...
    """
    coverage_end_date = columns.DateTimeColumn(verbose_name=_("Coverage End Date"))
    warranty_end_date = columns.DateTimeColumn(verbose_name=_("Warranty End Date"))
    eox_announcement_date = columns.DateTimeColumn(verbose_name=_("EOX Announcement Date"))
    end_of_sale_date = columns.DateTimeColumn(verbose_name=_("End of Sale Date"))
    end_of_sw_maintenance_releases = columns.DateTimeColumn(verbose_name=_("End of Sw-Maint Date"))
    end_of_security_vul_support_date = columns.DateTimeColumn(verbose_name=_("End of Vul-Supp Date"))
    end_of_routine_failure_analysis_date = columns.DateTimeColumn(verbose_name=_("End of Failure Analysis Date"))
    end_of_service_contract_renewal = columns.DateTimeColumn(verbose_name=_("End of Contract Renewal Date"))
    end_of_svc_attach_date = columns.DateTimeColumn(verbose_name=_("End of Svc-Attach Date"))
    last_date_of_support = columns.DateTimeColumn(verbose_name=_("Last Date of Support"))
    """
