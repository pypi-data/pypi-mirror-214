...
def preprocess_embeddings(trained_model: Popari, level=None, normalized_key="normalized_X"):
...
def leiden(trained_model: Popari, use_rep="normalized_X", joint: bool = False, resolution: float = 1.0, target_clusters: Optional[int] = None, level=None, tolerance: float = 0.05):
...
def cluster(trained_model: Popari, use_rep="normalized_X", joint: bool = False, method: str = "leiden", resolution: float = 1.0, target_clusters: Optional[int] = None, level=None, tolerance: float = 0.01):
