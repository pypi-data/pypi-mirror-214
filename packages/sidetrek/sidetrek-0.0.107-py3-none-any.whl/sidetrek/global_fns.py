...
def load_custom_objects(bentoml_model_tag: str, key: str, test_prefix: Optional[str] = None) -> Dict[str, Any]:
    """
    ...
    custom_objects_local_path = Path.cwd() / f"src/{GENERATED_SIDETREK_DIRNAME}/custom_objects/{user_prefix}" / f"{key}.cpkl"
