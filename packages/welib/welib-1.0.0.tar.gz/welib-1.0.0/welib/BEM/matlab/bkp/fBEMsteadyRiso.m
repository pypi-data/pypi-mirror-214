function [BEM CP CT CQ] = fBEMsteadyRiso()
...
%             opt.t_c
            ...
            % method interp Risoe
            ClCdCm_= fAeroCoeff(alpha,Profiles,Rotor.ProfileSet(e+(length(Iblade(Iblade==0))),:),Rotor.opt_rel_thickness(e+(length(Iblade(Iblade==0)))));
            Cl=ClCdCm_(:,1);
            Cd=ClCdCm_(:,2);
