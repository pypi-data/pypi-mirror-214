...
def computePsi(w, psi, u, v):              
    ...
    for it in range(1001):   
        ...
        psi2[:,nj-1] = 0.5*u[0,0]*pos_r[nj-1]**2
        #dpsi/dr = -u = 0 on rmax
...
nu = nu_k*nu0
inlet_nn = nj  #number of nodes making up inlet
outlet_nn = nj-3 #number of nodes in the outlet
...
plt.ion()
figs=fig_grid(2,2, ScreenName='LeftScreen')
fig1=figs[0]
fig2=figs[1]
fig3=figs[2]
fig4=figs[3]
