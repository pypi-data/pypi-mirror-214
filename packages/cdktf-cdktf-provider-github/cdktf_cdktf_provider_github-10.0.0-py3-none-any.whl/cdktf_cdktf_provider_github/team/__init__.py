...
Refer to the Terraform Registory for docs: [`github_team`](https://registry.terraform.io/providers/integrations/github/5.27.0/docs/resources/team).
'''
import abc
import builtins
import datetime
...
class Team(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: The name of the team. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.27.0/docs/resources/team#name Team#name}
        :param create_default_maintainer: Adds a default maintainer to the team. Adds the creating user to the team when 'true'. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.27.0/docs/resources/team#create_default_maintainer Team#create_default_maintainer}
        :param description: A description of the team. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.27.0/docs/resources/team#description Team#description}
        ...
        :param ldap_dn: The LDAP Distinguished Name of the group where membership will be synchronized. Only available in GitHub Enterprise Server. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.27.0/docs/resources/team#ldap_dn Team#ldap_dn}
        :param parent_team_id: The ID or slug of the parent team, if this is a nested team. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.27.0/docs/resources/team#parent_team_id Team#parent_team_id}
        :param privacy: The level of privacy for the team. Must be one of 'secret' or 'closed'. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.27.0/docs/resources/team#privacy Team#privacy}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
