...
Refer to the Terraform Registory for docs: [`github_branch`](https://registry.terraform.io/providers/integrations/github/5.27.0/docs/resources/branch).
'''
import abc
import builtins
import datetime
...
class Branch(
    ...
    def __init__(
        ...
        *,
        ...
        :param branch: The repository branch to create. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.27.0/docs/resources/branch#branch Branch#branch}
        :param repository: The GitHub repository name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.27.0/docs/resources/branch#repository Branch#repository}
        ...
        :param source_branch: The branch name to start from. Defaults to 'main'. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.27.0/docs/resources/branch#source_branch Branch#source_branch}
        :param source_sha: The commit hash to start from. Defaults to the tip of 'source_branch'. If provided, 'source_branch' is ignored. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/5.27.0/docs/resources/branch#source_sha Branch#source_sha}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
