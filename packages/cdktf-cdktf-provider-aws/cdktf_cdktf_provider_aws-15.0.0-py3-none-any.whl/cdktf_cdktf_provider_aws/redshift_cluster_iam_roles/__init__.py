...
Refer to the Terraform Registory for docs: [`aws_redshift_cluster_iam_roles`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/redshift_cluster_iam_roles).
'''
import abc
import builtins
import datetime
