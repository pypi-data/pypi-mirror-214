...
Refer to the Terraform Registory for docs: [`aws_inspector2_organization_configuration`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/inspector2_organization_configuration).
'''
import abc
import builtins
import datetime
