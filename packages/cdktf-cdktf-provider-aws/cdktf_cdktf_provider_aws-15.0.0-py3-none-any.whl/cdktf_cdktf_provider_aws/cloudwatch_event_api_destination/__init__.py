...
Refer to the Terraform Registory for docs: [`aws_cloudwatch_event_api_destination`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/cloudwatch_event_api_destination).
'''
import abc
import builtins
import datetime
