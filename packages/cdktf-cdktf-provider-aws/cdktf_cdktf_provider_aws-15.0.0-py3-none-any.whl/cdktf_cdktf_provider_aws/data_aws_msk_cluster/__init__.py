...
Refer to the Terraform Registory for docs: [`data_aws_msk_cluster`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/msk_cluster).
'''
import abc
import builtins
import datetime
