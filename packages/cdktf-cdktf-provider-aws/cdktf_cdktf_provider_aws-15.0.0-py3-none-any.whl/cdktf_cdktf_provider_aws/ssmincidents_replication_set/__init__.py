...
Refer to the Terraform Registory for docs: [`aws_ssmincidents_replication_set`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/ssmincidents_replication_set).
'''
import abc
import builtins
import datetime
