...
Refer to the Terraform Registory for docs: [`aws_emrserverless_application`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/emrserverless_application).
'''
import abc
import builtins
import datetime
