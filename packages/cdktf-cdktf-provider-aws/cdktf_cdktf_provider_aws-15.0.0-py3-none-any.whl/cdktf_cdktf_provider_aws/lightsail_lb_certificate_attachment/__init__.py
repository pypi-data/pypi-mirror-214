...
Refer to the Terraform Registory for docs: [`aws_lightsail_lb_certificate_attachment`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/lightsail_lb_certificate_attachment).
'''
import abc
import builtins
import datetime
