...
Refer to the Terraform Registory for docs: [`data_aws_appmesh_route`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/appmesh_route).
'''
import abc
import builtins
import datetime
