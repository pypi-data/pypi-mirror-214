...
Refer to the Terraform Registory for docs: [`data_aws_kms_secrets`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/kms_secrets).
'''
import abc
import builtins
import datetime
