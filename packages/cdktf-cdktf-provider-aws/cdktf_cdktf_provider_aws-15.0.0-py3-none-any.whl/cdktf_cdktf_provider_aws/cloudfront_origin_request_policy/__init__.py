...
Refer to the Terraform Registory for docs: [`aws_cloudfront_origin_request_policy`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/cloudfront_origin_request_policy).
'''
import abc
import builtins
import datetime
