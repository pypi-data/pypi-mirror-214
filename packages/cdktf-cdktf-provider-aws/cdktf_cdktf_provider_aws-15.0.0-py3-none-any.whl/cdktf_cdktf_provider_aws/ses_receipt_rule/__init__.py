...
Refer to the Terraform Registory for docs: [`aws_ses_receipt_rule`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/ses_receipt_rule).
'''
import abc
import builtins
import datetime
