...
Refer to the Terraform Registory for docs: [`aws_lightsail_key_pair`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/lightsail_key_pair).
'''
import abc
import builtins
import datetime
