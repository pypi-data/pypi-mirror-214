...
Refer to the Terraform Registory for docs: [`aws_vpc_security_group_ingress_rule`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/vpc_security_group_ingress_rule).
'''
import abc
import builtins
import datetime
