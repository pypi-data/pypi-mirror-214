...
Refer to the Terraform Registory for docs: [`aws_sagemaker_app_image_config`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/sagemaker_app_image_config).
'''
import abc
import builtins
import datetime
