...
Refer to the Terraform Registory for docs: [`aws_storagegateway_cached_iscsi_volume`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/storagegateway_cached_iscsi_volume).
'''
import abc
import builtins
import datetime
