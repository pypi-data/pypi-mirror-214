...
Refer to the Terraform Registory for docs: [`aws_ssoadmin_permissions_boundary_attachment`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/ssoadmin_permissions_boundary_attachment).
'''
import abc
import builtins
import datetime
