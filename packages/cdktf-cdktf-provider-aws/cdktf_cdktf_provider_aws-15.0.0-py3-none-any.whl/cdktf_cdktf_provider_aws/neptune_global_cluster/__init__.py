...
Refer to the Terraform Registory for docs: [`aws_neptune_global_cluster`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/neptune_global_cluster).
'''
import abc
import builtins
import datetime
