...
Refer to the Terraform Registory for docs: [`aws_iam_openid_connect_provider`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/iam_openid_connect_provider).
'''
import abc
import builtins
import datetime
