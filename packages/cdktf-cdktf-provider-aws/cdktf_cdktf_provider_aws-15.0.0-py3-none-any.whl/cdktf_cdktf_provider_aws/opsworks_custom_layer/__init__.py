...
Refer to the Terraform Registory for docs: [`aws_opsworks_custom_layer`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/opsworks_custom_layer).
'''
import abc
import builtins
import datetime
