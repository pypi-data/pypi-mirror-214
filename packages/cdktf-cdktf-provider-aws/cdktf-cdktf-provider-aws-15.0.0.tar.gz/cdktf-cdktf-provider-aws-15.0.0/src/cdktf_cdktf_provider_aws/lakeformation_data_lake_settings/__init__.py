...
Refer to the Terraform Registory for docs: [`aws_lakeformation_data_lake_settings`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/lakeformation_data_lake_settings).
'''
import abc
import builtins
import datetime
