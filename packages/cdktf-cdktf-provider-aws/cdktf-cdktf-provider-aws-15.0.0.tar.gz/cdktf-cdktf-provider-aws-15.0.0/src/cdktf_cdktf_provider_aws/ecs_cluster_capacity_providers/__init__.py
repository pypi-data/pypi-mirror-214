...
Refer to the Terraform Registory for docs: [`aws_ecs_cluster_capacity_providers`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/ecs_cluster_capacity_providers).
'''
import abc
import builtins
import datetime
