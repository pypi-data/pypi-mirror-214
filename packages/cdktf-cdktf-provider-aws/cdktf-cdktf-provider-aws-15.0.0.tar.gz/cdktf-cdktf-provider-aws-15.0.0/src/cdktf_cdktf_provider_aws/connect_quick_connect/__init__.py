...
Refer to the Terraform Registory for docs: [`aws_connect_quick_connect`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/connect_quick_connect).
'''
import abc
import builtins
import datetime
