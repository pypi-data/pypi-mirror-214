...
Refer to the Terraform Registory for docs: [`aws_quicksight_refresh_schedule`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/quicksight_refresh_schedule).
'''
import abc
import builtins
import datetime
