...
Refer to the Terraform Registory for docs: [`aws_sagemaker_data_quality_job_definition`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/sagemaker_data_quality_job_definition).
'''
import abc
import builtins
import datetime
