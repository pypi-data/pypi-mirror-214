...
Refer to the Terraform Registory for docs: [`aws_ssmcontacts_plan`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/ssmcontacts_plan).
'''
import abc
import builtins
import datetime
