...
Refer to the Terraform Registory for docs: [`aws_s3_bucket_ownership_controls`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/s3_bucket_ownership_controls).
'''
import abc
import builtins
import datetime
