...
Refer to the Terraform Registory for docs: [`aws_comprehend_entity_recognizer`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/comprehend_entity_recognizer).
'''
import abc
import builtins
import datetime
