...
Refer to the Terraform Registory for docs: [`aws_inspector_assessment_template`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/inspector_assessment_template).
'''
import abc
import builtins
import datetime
