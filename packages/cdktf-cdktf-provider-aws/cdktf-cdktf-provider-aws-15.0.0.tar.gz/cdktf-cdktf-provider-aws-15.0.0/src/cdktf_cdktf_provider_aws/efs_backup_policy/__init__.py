...
Refer to the Terraform Registory for docs: [`aws_efs_backup_policy`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/efs_backup_policy).
'''
import abc
import builtins
import datetime
