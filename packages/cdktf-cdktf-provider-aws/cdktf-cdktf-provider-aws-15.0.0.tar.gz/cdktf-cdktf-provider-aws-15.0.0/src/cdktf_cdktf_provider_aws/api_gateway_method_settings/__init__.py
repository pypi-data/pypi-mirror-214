...
Refer to the Terraform Registory for docs: [`aws_api_gateway_method_settings`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/api_gateway_method_settings).
'''
import abc
import builtins
import datetime
