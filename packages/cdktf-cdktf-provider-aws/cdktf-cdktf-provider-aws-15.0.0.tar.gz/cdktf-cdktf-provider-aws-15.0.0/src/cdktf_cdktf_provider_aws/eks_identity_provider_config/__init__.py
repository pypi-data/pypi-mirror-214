...
Refer to the Terraform Registory for docs: [`aws_eks_identity_provider_config`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/eks_identity_provider_config).
'''
import abc
import builtins
import datetime
