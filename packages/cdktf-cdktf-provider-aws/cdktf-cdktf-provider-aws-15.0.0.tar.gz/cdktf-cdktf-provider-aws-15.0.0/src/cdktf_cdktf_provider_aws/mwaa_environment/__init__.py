...
Refer to the Terraform Registory for docs: [`aws_mwaa_environment`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/mwaa_environment).
'''
import abc
import builtins
import datetime
