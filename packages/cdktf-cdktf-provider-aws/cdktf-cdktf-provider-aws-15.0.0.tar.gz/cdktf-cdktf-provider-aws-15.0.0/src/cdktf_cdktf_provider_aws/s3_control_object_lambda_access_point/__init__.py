...
Refer to the Terraform Registory for docs: [`aws_s3control_object_lambda_access_point`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/s3control_object_lambda_access_point).
'''
import abc
import builtins
import datetime
