...
Refer to the Terraform Registory for docs: [`aws_autoscalingplans_scaling_plan`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/autoscalingplans_scaling_plan).
'''
import abc
import builtins
import datetime
