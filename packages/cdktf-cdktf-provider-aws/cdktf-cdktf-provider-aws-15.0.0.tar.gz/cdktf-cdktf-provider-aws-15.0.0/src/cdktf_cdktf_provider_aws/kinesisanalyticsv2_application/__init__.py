...
Refer to the Terraform Registory for docs: [`aws_kinesisanalyticsv2_application`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/kinesisanalyticsv2_application).
'''
import abc
import builtins
import datetime
