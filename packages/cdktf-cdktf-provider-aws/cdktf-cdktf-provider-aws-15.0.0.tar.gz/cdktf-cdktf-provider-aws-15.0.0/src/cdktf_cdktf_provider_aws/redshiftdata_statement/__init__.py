...
Refer to the Terraform Registory for docs: [`aws_redshiftdata_statement`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/redshiftdata_statement).
'''
import abc
import builtins
import datetime
