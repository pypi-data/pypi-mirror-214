...
Refer to the Terraform Registory for docs: [`aws_devicefarm_device_pool`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/devicefarm_device_pool).
'''
import abc
import builtins
import datetime
