...
Refer to the Terraform Registory for docs: [`aws_wafregional_web_acl`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/wafregional_web_acl).
'''
import abc
import builtins
import datetime
