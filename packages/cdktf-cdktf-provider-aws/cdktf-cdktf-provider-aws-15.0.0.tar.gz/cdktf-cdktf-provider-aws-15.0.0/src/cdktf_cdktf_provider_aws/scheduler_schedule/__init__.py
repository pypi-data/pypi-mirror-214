...
Refer to the Terraform Registory for docs: [`aws_scheduler_schedule`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/scheduler_schedule).
'''
import abc
import builtins
import datetime
