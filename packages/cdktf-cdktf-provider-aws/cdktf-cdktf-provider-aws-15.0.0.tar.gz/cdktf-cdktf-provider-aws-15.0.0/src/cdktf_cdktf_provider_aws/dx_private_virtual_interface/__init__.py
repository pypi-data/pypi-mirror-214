...
Refer to the Terraform Registory for docs: [`aws_dx_private_virtual_interface`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/dx_private_virtual_interface).
'''
import abc
import builtins
import datetime
