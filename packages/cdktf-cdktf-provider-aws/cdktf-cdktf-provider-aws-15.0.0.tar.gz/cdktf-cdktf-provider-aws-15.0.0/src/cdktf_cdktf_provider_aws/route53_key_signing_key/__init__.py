...
Refer to the Terraform Registory for docs: [`aws_route53_key_signing_key`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/route53_key_signing_key).
'''
import abc
import builtins
import datetime
