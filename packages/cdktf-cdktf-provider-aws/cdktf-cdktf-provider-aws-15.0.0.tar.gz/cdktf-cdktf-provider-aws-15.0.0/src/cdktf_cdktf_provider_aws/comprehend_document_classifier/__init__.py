...
Refer to the Terraform Registory for docs: [`aws_comprehend_document_classifier`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/comprehend_document_classifier).
'''
import abc
import builtins
import datetime
