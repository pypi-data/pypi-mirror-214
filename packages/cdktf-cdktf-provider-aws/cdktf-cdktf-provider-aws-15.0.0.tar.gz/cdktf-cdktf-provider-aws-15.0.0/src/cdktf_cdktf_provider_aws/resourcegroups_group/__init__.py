...
Refer to the Terraform Registory for docs: [`aws_resourcegroups_group`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/resourcegroups_group).
'''
import abc
import builtins
import datetime
