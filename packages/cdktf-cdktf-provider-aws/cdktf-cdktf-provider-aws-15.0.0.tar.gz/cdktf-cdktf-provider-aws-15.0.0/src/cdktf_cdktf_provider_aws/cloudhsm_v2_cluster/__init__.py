...
Refer to the Terraform Registory for docs: [`aws_cloudhsm_v2_cluster`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/cloudhsm_v2_cluster).
'''
import abc
import builtins
import datetime
