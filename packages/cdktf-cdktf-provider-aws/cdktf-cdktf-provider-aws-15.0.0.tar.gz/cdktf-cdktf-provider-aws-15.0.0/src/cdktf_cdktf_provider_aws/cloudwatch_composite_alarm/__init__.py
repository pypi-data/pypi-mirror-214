...
Refer to the Terraform Registory for docs: [`aws_cloudwatch_composite_alarm`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/cloudwatch_composite_alarm).
'''
import abc
import builtins
import datetime
