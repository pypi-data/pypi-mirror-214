...
class QuicksightTemplate(
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["QuicksightTemplateTimeouts", _cdktf_9a9027ec.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["QuicksightTemplateTimeouts", _cdktf_9a9027ec.IResolvable]], jsii.get(self, "timeoutsInput"))
...
class QuicksightTemplatePermissionsOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[QuicksightTemplatePermissions, _cdktf_9a9027ec.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[QuicksightTemplatePermissions, _cdktf_9a9027ec.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[QuicksightTemplatePermissions, _cdktf_9a9027ec.IResolvable]],
    ) -> None:
        if __debug__:
...
class QuicksightTemplateSourceEntitySourceAnalysisDataSetReferencesOutputReference(
    ...
    def internal_value(
        self,
    ) -> typing.Optional[typing.Union[QuicksightTemplateSourceEntitySourceAnalysisDataSetReferences, _cdktf_9a9027ec.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[QuicksightTemplateSourceEntitySourceAnalysisDataSetReferences, _cdktf_9a9027ec.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[QuicksightTemplateSourceEntitySourceAnalysisDataSetReferences, _cdktf_9a9027ec.IResolvable]],
    ) -> None:
        if __debug__:
...
class QuicksightTemplateTimeoutsOutputReference(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[QuicksightTemplateTimeouts, _cdktf_9a9027ec.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[QuicksightTemplateTimeouts, _cdktf_9a9027ec.IResolvable]],
    ) -> None:
        if __debug__:
