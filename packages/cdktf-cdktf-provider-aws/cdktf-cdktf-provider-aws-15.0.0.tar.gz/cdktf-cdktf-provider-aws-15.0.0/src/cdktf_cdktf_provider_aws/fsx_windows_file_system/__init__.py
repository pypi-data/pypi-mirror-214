...
Refer to the Terraform Registory for docs: [`aws_fsx_windows_file_system`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/fsx_windows_file_system).
'''
import abc
import builtins
import datetime
