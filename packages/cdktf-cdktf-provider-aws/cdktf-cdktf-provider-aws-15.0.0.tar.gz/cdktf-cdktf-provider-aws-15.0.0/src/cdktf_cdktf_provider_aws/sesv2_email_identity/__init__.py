...
Refer to the Terraform Registory for docs: [`aws_sesv2_email_identity`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/sesv2_email_identity).
'''
import abc
import builtins
import datetime
