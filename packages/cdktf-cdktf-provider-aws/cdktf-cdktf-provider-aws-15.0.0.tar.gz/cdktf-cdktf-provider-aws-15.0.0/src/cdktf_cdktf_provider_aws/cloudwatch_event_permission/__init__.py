...
Refer to the Terraform Registory for docs: [`aws_cloudwatch_event_permission`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/cloudwatch_event_permission).
'''
import abc
import builtins
import datetime
