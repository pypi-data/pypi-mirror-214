...
Refer to the Terraform Registory for docs: [`aws_lb_target_group_attachment`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/lb_target_group_attachment).
'''
import abc
import builtins
import datetime
