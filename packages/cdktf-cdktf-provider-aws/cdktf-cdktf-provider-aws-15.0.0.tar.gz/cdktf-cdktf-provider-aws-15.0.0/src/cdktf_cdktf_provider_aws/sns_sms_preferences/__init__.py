...
Refer to the Terraform Registory for docs: [`aws_sns_sms_preferences`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/sns_sms_preferences).
'''
import abc
import builtins
import datetime
