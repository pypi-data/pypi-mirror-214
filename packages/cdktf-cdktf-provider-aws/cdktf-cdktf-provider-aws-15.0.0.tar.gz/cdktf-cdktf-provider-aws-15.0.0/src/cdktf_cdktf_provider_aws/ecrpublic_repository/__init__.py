...
Refer to the Terraform Registory for docs: [`aws_ecrpublic_repository`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/ecrpublic_repository).
'''
import abc
import builtins
import datetime
