...
_POSTPROCESSINGSDEPRECATED_POSTPROCESSINGMIXDEPRECATED = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='segmentation', full_name='buffers.protobuf.nn.postprocessing.PostprocessingsDeprecated.PostprocessingMixDeprecated.segmentation', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_POSTPROCESSINGSDEPRECATED_POSTPROCESSINGMIXDEPRECATED.fields_by_name['segmentation'].message_type = _SEGMENTATION
...
_POSTPROCESSINGSDEPRECATED_POSTPROCESSINGMIXDEPRECATED.oneofs_by_name['type'].fields.append(
  _POSTPROCESSINGSDEPRECATED_POSTPROCESSINGMIXDEPRECATED.fields_by_name['segmentation'])
_POSTPROCESSINGSDEPRECATED_POSTPROCESSINGMIXDEPRECATED.fields_by_name['segmentation'].containing_oneof = _POSTPROCESSINGSDEPRECATED_POSTPROCESSINGMIXDEPRECATED.oneofs_by_name['type']
