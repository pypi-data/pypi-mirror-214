...
The sources for Stochastic Matching can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/balouf/stochastic_matching
.. _tarball: https://github.com/balouf/stochastic_matching/tarball/master
