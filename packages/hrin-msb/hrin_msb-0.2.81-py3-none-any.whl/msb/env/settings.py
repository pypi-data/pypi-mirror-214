...
MSB_DEFAULT_BRODCAST_QUEUES = [
	NameConst.EMPLOYEE_SERVICE_QUEUE_NAME, NameConst.LEAVE_SERVICE_QUEUE_NAME, NameConst.PROJECT_SERVICE_QUEUE_NAME,
	NameConst.CONF_SERVICE_QUEUE_NAME, NameConst.AUTOPILOT_SERVICE_QUEUE_NAME
]
