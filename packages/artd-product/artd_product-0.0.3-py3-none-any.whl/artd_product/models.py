...
class Product(ProductBaseModel, SearchEngine):
    ...
    special_price = models.DecimalField(
        _("Special price"),
        help_text=_("Enter the special price of the product"),
        max_digits=10,
        decimal_places=2,
        default=0.00,
    )
    special_price_from = models.DateTimeField(
        ...
        help_text=_("Enter the special price from of the product"),
        null=True,
        blank=True,
    )
    special_price_to = models.DateTimeField(
        _("Special price to"),
        help_text=_("Enter the special price to of the product"),
        null=True,
        blank=True,
    )
    stock = models.IntegerField(
        _("Stock"),
        help_text=_("Enter the stock of the product"),
        default=0,
    )
