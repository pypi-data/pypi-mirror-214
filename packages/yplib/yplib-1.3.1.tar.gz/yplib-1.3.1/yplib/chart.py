...
#             },
#         ]
def to_chart(x_list, y_list, name=None, name_raw=False):
...
#         [ "Video Ads",300 ]
#       ]
def to_chart_pie(data_list, name=None, name_index=0, value_index=1):
    x_list = []
...
#        {x: "Video Ads", y:300 }
#       }]
def to_chart_bar(data_list, name=None, x_index=0, y_index=1):
    x_list = []
    y_list = []
