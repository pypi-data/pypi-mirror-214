...
class ProjectsApi(object):
    ...
    def modify_project_settings_with_http_info(self, project_id, body, **kwargs):  # noqa: E501
        ...
        body_params = None
        if 'body' in params:
            if 'ProjectSharingSettingsProjectSettingsInput'.startswith('union'):
                body_type = type(params['body'])
                if getattr(body_type, 'positional_to_model', None):
                    body_params = body_type.positional_to_model(params['body'])
                else:
                ...
                body_params = flywheel.models.ProjectSharingSettingsProjectSettingsInput.positional_to_model(params['body'])
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/projects/{ProjectId}/settings', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ProjectSharingSettingsProjectSettingsOutput',  # noqa: E501
            auth_settings=auth_settings,
            async_=params.get('async_'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def upload_file_to_project(self, cid, file, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_'):
            return self.upload_file_to_project_with_http_info(cid, file, **kwargs)  # noqa: E501
        else:
            (data) = self.upload_file_to_project_with_http_info(cid, file, **kwargs)  # noqa: E501
            if (
                data
                and hasattr(data, 'return_value')
                and not ignore_simplified_return_value
    ...
    def upload_file_to_project_with_http_info(self, cid, file, **kwargs):  # noqa: E501
        """Upload a file to project.
        ...
        all_params = ['cid','file','preserve_metadata','ticket','metadata','x_accept_feature',]  # noqa: E501
        all_params.append('async_')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('cid' not in params or
                params['cid'] is None):
            raise ValueError("Missing the required parameter `cid` when calling `upload_file_to_project`")  # noqa: E501
        # verify the required parameter 'file' is set
        if ('file' not in params or
                params['file'] is None):
    ...
    def upload_output_to_project_analysis_with_http_info(self, cid, analysis_id, file, **kwargs):  # noqa: E501
        ...
        all_params = ['cid','analysis_id','file',]  # noqa: E501
        all_params.append('async_')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def upsert_project_hierarchy_with_http_info(self, project_id, body, **kwargs):  # noqa: E501
        ...
        body_params = None
        if 'body' in params:
            if 'ProjectHierarchyUpsertInput'.startswith('union'):
                body_type = type(params['body'])
                if getattr(body_type, 'positional_to_model', None):
                    body_params = body_type.positional_to_model(params['body'])
                else:
                ...
                body_params = flywheel.models.ProjectHierarchyUpsertInput.positional_to_model(params['body'])
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/projects/{ProjectId}/upsert-hierarchy', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ProjectHierarchyUpsertOutput',  # noqa: E501
            auth_settings=auth_settings,
            async_=params.get('async_'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
