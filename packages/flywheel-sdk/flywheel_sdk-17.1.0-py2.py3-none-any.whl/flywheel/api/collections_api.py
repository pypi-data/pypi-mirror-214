...
class CollectionsApi(object):
    ...
    def upload_file_to_collection(self, cid, file, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_'):
            return self.upload_file_to_collection_with_http_info(cid, file, **kwargs)  # noqa: E501
        else:
            (data) = self.upload_file_to_collection_with_http_info(cid, file, **kwargs)  # noqa: E501
            if (
                data
                and hasattr(data, 'return_value')
                and not ignore_simplified_return_value
    ...
    def upload_file_to_collection_with_http_info(self, cid, file, **kwargs):  # noqa: E501
        """Upload a file to collection.
        ...
        if ('cid' not in params or
                params['cid'] is None):
            raise ValueError("Missing the required parameter `cid` when calling `upload_file_to_collection`")  # noqa: E501
