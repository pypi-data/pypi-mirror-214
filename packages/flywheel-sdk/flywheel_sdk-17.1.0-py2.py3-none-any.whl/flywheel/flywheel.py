...
class Flywheel:
    ...
    def upload_file_to_acquisition(self, cid, file, signed=True, **kwargs):  # noqa: E501
        ...
        """
        if signed:
            signed_result = self.signed_upload_file_to_acquisition(cid, file, **kwargs)
            if signed_result:
    ...
    def upload_file_to_collection(self, cid, file, signed=True, **kwargs):  # noqa: E501
        ...
        """
        if signed:
            signed_result = self.signed_upload_file_to_collection(cid, file, **kwargs)
            if signed_result:
                return signed_result
    ...
    def upload_file_to_container(self, cid, file, signed=True, **kwargs):  # noqa: E501
        ...
        """
        if signed:
            signed_result = self.signed_upload_file_to_container(cid, file, **kwargs)
            if signed_result:
                return signed_result
    ...
    def upload_file_to_project(self, cid, file, signed=True, **kwargs):  # noqa: E501
        ...
        """
        if signed:
            signed_result = self.signed_upload_file_to_project(cid, file, **kwargs)
            if signed_result:
                return signed_result
    ...
    def upload_file_to_session(self, cid, file, signed=True, **kwargs):  # noqa: E501
        ...
        """
        if signed:
            signed_result = self.signed_upload_file_to_session(cid, file, **kwargs)
            if signed_result:
                return signed_result
    ...
    def upload_file_to_subject(self, cid, file, signed=True, **kwargs):  # noqa: E501
        ...
        """
        if signed:
            signed_result = self.signed_upload_file_to_subject(cid, file, **kwargs)
            if signed_result:
                return signed_result
    ...
    def _ticketed_upload(self, ctype, cid, fname, metadata=None, ticket="", **params):
        ...
        endpoint = "/{ctype}/{cid}/files"
        return self.api_client.call_api("/{ctype}/{cid}/files", "POST",
            {"ctype": ctype, "cid": cid},
            query_params,
            header_params,
            **kwargs)
