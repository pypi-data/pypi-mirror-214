...
class User(BaseModel):
    ...
    def save_user_to_collection(self, request: Request = None, mongodb: MongoDB = None):
    ...
    def save_smart_contracts(
        self, request: Request, smart_contract_request: SmartContractRequest
    ):
    ...
    def save_unstake_limit(
        self, request: Request, unstake_limit_request: UnstakeLimitRequest
    ):
        self.unstake_limit_notifier = unstake_limit_request.limit
        self.save_user_to_collection(request)

    def save_limit(
        self, request: Request, transaction_limit_request: TransactionLimitRequest
    ):
    ...
    def save_transactions_download(self, request: Request, account_id):
    ...
    def remove_item(self, request: Request, delete_item_request: DeleteItemRequest):
        try:
