...
faster_rcnn.add_backbone(bb.INCEPTION_RESNET_V2, args=ARGS_0002, pretrained_parameters={
    # DataType.NATURAL_RGB: 'tensorflow/natural_rgb/inception_resnet_v2-faster_rcnn-coco-2018_01_28.tar.gz',
}),
faster_rcnn.add_backbone(bb.INCEPTION_V2, args=ARGS_0002),
faster_rcnn.add_backbone(bb.NASNET_LARGE, args=ARGS_0003, pretrained_parameters={
    # DataType.NATURAL_RGB: 'tensorflow/natural_rgb/nasnet_large-faster_rcnn-coco-2018_01_28.tar.gz',
}),
faster_rcnn.add_backbone(bb.PNASNET_LARGE, args=ARGS_0003),
faster_rcnn.add_backbone(bb.RESNET_50_V1, args=ARGS_0003, pretrained_parameters={
    DataType.NATURAL_RGB: 'tensorflow/natural_rgb/resnet_50_v1-faster_rcnn-coco-2020_04_14.tar.gz'
}),
faster_rcnn.add_backbone(bb.RESNET_101_V1, args=ARGS_0003, pretrained_parameters={
    DataType.NATURAL_RGB: 'tensorflow/natural_rgb/resnet_101_v1-faster_rcnn-coco-2020_04_14.tar.gz'
}),
faster_rcnn.add_backbone(bb.RESNET_152_V1, args=ARGS_0003)

for backbone in bb:
    if backbone not in [bb.DARKNET_19, bb.DARKNET_53]:
        faster_rcnn.add_backbone(backbone, args=ARGS_0002, skip_existing_aliases=True)
...
rfcn.add_backbone(bb.INCEPTION_RESNET_V2, args=ARGS_0003)
rfcn.add_backbone(bb.INCEPTION_V2, args=ARGS_0003)
rfcn.add_backbone(bb.NASNET_LARGE, args=ARGS_0003)
rfcn.add_backbone(bb.PNASNET_LARGE, args=ARGS_0003)
rfcn.add_backbone(bb.RESNET_50_V1, args=ARGS_0003)
rfcn.add_backbone(bb.RESNET_101_V1, args=ARGS_0003, pretrained_parameters={
    DataType.NATURAL_RGB: 'tensorflow/natural_rgb/resnet_101_v1-rfcn-coco-2018_01_28.tar.gz'
})
rfcn.add_backbone(bb.RESNET_152_V1, args=ARGS_0003)

for backbone in bb:
    if backbone not in [bb.DARKNET_19, bb.DARKNET_53]:
        rfcn.add_backbone(backbone, args=ARGS_0003, skip_existing_aliases=True)
