...
class STTS22H:
    ...
    **Quickstart: Importing and using the device**
    ...
    _freerun = CBits(1, _CTRL, 2)
    _output_data_rate = CBits(2, _CTRL, 4)

    _temperature_LSB = RegisterStruct(0x06, "B")
    _temperature_MSB = RegisterStruct(0x07, "B")

    _high_limit = CBits(1, 0x05, 1)
    _low_limit = CBits(1, 0x05, 2)

    def __init__(self, i2c, address: int = 0x3C) -> None:
        self._i2c = i2c
