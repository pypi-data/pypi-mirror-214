...
def _get_kwargs(
    *,
    ...
    url = "{}/repo/service/dynamic".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    """Get repo dynamic services

     To fetch all dynamic services owned by the user from a specific repo. These are equivalent to the
    services in the previous version.
