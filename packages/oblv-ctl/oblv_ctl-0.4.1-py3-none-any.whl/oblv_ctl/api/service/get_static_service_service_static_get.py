...
from ...models.static_service import StaticService
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[HTTPValidationError, MessageModel, StaticService]]:
    if response.status_code == 200:
        response_200 = StaticService.from_dict(response.json())
...
def _build_response(*, response: httpx.Response) -> Response[Union[HTTPValidationError, MessageModel, StaticService]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    oblivious_user_id: str,
    service: str,
) -> Response[Union[HTTPValidationError, MessageModel, StaticService]]:
    """Get static service

     To fetch static service. It returns the service if it is either privately owned by user, or
    ...
    Returns:
        Union[HTTPValidationError, MessageModel, StaticService]
    """
...
def sync(
    *,
    ...
    oblivious_user_id: str,
    service: str,
) -> Optional[Union[HTTPValidationError, MessageModel, StaticService]]:
    """Get static service

     To fetch static service
