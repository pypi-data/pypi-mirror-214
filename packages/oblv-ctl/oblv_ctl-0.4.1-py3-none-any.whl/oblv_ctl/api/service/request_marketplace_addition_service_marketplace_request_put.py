...
from ...exceptions import ParamValidationError, UnauthorizedTokenError, HTTPClientError, BadRequestError
...
def _get_kwargs(
    *,
    ...
    url = "{}/service/marketplace/request".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    """Request to move static service to marketplace
