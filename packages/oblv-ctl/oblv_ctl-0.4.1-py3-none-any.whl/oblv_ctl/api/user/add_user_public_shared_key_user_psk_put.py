...
def _parse_response(*, response: httpx.Response) -> Optional[Union[HTTPValidationError, MessageModel, PSK]]:
    if response.status_code == 200:
        response_200 = PSK.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Union[HTTPValidationError, MessageModel, PSK]
    """
