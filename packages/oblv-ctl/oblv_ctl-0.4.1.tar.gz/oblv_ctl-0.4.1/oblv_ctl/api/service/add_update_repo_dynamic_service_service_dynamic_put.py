...
from ...models.dynamic_service_yaml_input import DynamicServiceYamlInput
...
def _get_kwargs(
    *,
    ...
    json_body: DynamicServiceYamlInput,
...
def sync_detailed(
    *,
    ...
    """Add/Update Repo Service

     API to update a service. It fetches the current service.yaml file from VCS and validate it.

    Use this in place of old **GET /repo/service/validate** API.
