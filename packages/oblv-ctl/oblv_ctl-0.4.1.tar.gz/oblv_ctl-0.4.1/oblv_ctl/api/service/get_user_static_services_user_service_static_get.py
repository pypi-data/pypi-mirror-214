...
from ...models.service_filter_type import ServiceFilterType
from ...models.user_service_list_user_static_service import UserServiceListUserStaticService
...
def _get_kwargs(
    *,
    ...
    service_type: Union[Unset, None, ServiceFilterType] = ServiceFilterType.ALL,
) -> Dict[str, Any]:
    url = "{}/user/service/static".format(client.base_url)
    ...
    json_service_type: Union[Unset, None, str] = UNSET
    if not isinstance(service_type, Unset):
        json_service_type = service_type.value if service_type else None
...
) -> Optional[Union[Any, HTTPValidationError, MessageModel, UserServiceListUserStaticService]]:
    if response.status_code == 200:
        response_200 = UserServiceListUserStaticService.from_dict(response.json())
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[Any, HTTPValidationError, MessageModel, UserServiceListUserStaticService]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get user static services

     To fetch all static services owned by the user.
    ...
    Args:
        ...
        get_all (Union[Unset, None, bool]): Get all responses. Precedence over *page* and
            *per_page* parameters
        service_type (Union[Unset, None, ServiceFilterType]): An enumeration. Default:
    ...
    Returns:
        Union[Any, HTTPValidationError, MessageModel, UserServiceListUserStaticService]
    """
