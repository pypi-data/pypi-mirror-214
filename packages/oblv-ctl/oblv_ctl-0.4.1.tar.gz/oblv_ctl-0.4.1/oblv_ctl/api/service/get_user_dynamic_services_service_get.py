...
def sync_detailed(
    *,
    ...
    """Get user dynamic services
     ...
     API to fetch user's services. This API is deprecated and will not be supported from upcoming
    releases. Kindly use GET /user/service/dynamic for list of user's dynamic services
