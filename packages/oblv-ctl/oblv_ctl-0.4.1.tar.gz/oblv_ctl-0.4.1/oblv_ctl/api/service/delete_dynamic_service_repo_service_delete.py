...
def sync_detailed(
    *,
    ...
    """Delete Repo Service
     ...
     API to delete a service. It does not delete the existing deployments created from this service. This
    API is deprecated and will not be supported from upcoming releases. Kindly use DELETE
    /service/dynamic to delete dynamic services
