...
T = TypeVar("T", bound="RepoStaticService")


@attr.s(auto_attribs=True, repr=False)
class RepoStaticService:
    """
    Attributes:
        ...
        arguments (Union[Unset, RepoStaticServiceArguments]):
    ...
    arguments: Union[Unset, "RepoStaticServiceArguments"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_arguments, Unset):
            ...
            arguments = RepoStaticServiceArguments.from_dict(_arguments)
        ...
        repo_static_service.additional_properties = d
        return repo_static_service
