...
class ClusterDaemon(OTPmeDaemon):
        ...
        while True:
            ...
            if self.node_conn is None:
                ...
                try:
                    ...
                    msg = ("Failed to get cluster lock connection: %s: %s"
                            % (node_name, e))
                    self.logger.warning(msg)
                    start_over = True
                    time.sleep(1)
    ...
    def handle_lock_journal(self, node_name):
        ...
        for lock_entry_dir in lock_journal_dirs:
            ...
            if node_name in lock_journal_entry.get_nodes():
                self.check_lock_member_nodes(lock_journal_entry)
                continue
            ...
            # Check if lock was sent to all member nodes.
            self.check_lock_member_nodes(lock_journal_entry)
    ...
    def check_lock_member_nodes(self, lock_journal_entry):
        """ Make sure locks are sent to all member nodes. """
