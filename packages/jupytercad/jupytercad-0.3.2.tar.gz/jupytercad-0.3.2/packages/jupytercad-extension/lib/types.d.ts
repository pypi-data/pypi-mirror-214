...
import { MapChange, YDocument, StateChange, DocumentChange } from '@jupyter/ydoc';
import { ISignal, Signal } from '@lumino/signaling';
import { JSONObject } from '@lumino/coreutils';
import { IJupyterCadTracker } from './token';
import { IJCadContent, IJCadObject, IJCadModel, IJCadOptions } from './_interface/jcad';
 ...
 */
export declare enum WorkerAction {
    LOAD_FILE = "LOAD_FILE",
    SAVE_FILE = "SAVE_FILE",
    REGISTER = "REGISTER"
}
...
export interface IJupyterCadModel extends DocumentRegistry.IModel {
    ...
    themeChanged: Signal<IJupyterCadModel, IChangedArgs<string, string | null, string>>;
    clientStateChanged: ISignal<IJupyterCadModel, Map<number, IJupyterCadClientState>>;
