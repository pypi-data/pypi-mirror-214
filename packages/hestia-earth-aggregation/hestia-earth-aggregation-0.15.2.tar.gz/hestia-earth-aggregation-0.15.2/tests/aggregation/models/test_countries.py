...
@patch('hestia_earth.aggregation.cycle.quality_score.is_in_system_boundary', return_value=False)
@patch('hestia_earth.aggregation.cycle.emission.is_in_system_boundary', return_value=True)
