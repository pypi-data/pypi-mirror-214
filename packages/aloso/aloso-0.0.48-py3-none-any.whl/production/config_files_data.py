...
ExecStart=/home/developpeur/Project/network-backend-switch_merge/env/bin/gunicorn api.server:app -k uvicorn.workers.UvicornWorker --bind localhost:8002 --access-logfile /home/developpeur/Project/network-backend-switch_merge/logs/access_log.log --error-logfile /home/developpeur/Project/network-backend-switch_merge/logs/error_log.log --log-level debug
