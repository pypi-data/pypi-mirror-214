...
class ReadSensorsWithTypesResponse(IResponseGetterMixin):
    ...
    @staticmethod
    def from_dpa(dpa: bytes) -> ReadSensorsWithTypesResponse:
        ...
        if rcode == ResponseCodes.OK:
            ...
            result = {'sensors': SensorParser.read_sensors_from_dpa(pdata)}
        return ReadSensorsWithTypesResponse(nadr=nadr, hwpid=hwpid, rcode=rcode, dpa_value=dpa_value, pdata=pdata,
                                            result=result)

    @staticmethod
    def from_json(json: dict) -> ReadSensorsWithTypesResponse:
        ...
        if rcode == ResponseCodes.OK:
            result = {'sensors': SensorParser.read_sensors_from_json(result['sensors'])}
        return ReadSensorsWithTypesResponse(msgid=msgid, nadr=nadr, hwpid=hwpid, dpa_value=dpa_value, rcode=rcode,
