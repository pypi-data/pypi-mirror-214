...
class AzureStorageQueue:
    ...
    def __init__(self, storage_account_url, queue_name, tenant_id, client_id, client_secret):
        ...
        self.queue_service = QueueServiceClient(account_url= storage_account_url, credential=credential)
