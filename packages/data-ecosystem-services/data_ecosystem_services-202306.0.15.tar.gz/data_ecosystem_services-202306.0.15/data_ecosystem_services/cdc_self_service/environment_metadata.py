...
AZURE_CLIENT_ID {sp_client_id}
        ...
        set_key(dotenv_file,"APPLICATIONINSIGHTS_CONNECTION_STRING", applicaton_insights_connection_string)
    ...
    def get_configuration_common(cls, parameters: dict, dbutils) -> dict:
        ...
        az_sub_oauth_token_endpoint = config["az_sub_oauth_token_endpoint"]
