...
setup(
    name='invoicing-xltopdf',  # * Your package will have this name
    ...
    author='Malick Hamidou',  # Your name
    author_email='malicksender@gmail.com',  # Your email
    url='https://github.com/Molotovsefyu49/invoice-python-package',
