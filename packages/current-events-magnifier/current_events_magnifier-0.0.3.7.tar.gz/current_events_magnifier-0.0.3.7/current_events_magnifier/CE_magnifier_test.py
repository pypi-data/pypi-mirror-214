...
def init_parser():
    ...
    parser.set_defaults(function='tombo', chrom="NR_103073.1", pos=2030, len=10, strand='+', cpu=4,input_fast5='/data/Ecoli_23s/data/L_rep2/single/',\
                        control_fast5='/data/Ecoli_23s/data/IVT_negative/single/',output='tombo_result',overplot_number=300,ref="/data/Ecoli_23s/23S_rRNA.fasta",\
                        basecall_group="RawGenomeCorrected_000", basecall_subgroup="BaseCalled_template")
