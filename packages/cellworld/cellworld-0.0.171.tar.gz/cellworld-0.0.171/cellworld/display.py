...
class Display:
    ...
    def _draw_cells__(self):
        ...
        for cell in self.world.cells:
            ...
            self.cell_outline_polygons.append(self.ax.add_patch(RegularPolygon((cell.location.x, cell.location.y), self.world.configuration.cell_shape.sides, self.cells_size, facecolor=color, edgecolor=edge_color, orientation=self.cells_theta, zorder=self.cell_outline_zorder, linewidth=1, alpha=self.cell_outline_alpha)))
            self.cell_polygons.append(self.ax.add_patch(RegularPolygon((cell.location.x, cell.location.y), self.world.configuration.cell_shape.sides, self.cells_size * self.outline, facecolor=color, orientation=self.cells_theta, zorder=self.cell_zorder, linewidth=1, alpha=self.cell_alpha)))
