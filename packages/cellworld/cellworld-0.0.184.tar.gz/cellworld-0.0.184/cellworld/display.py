...
def EpisodeRepresentation(episode: Episode, video_path: str, frames: list, world: World, colors={"prey": "blue", "predator": "red"}, cols=0, figsize=(10,10), **kwargs):
    import cv2
    ...
    for i, frame in enumerate(frames):
        ...
        displays[-1].set_background(cropped_frames[frame], 1)
        displays[-1].add_trajectories(episode.trajectories, colors=colors, start_frame=pf, end_frame=frame, auto_alpha=True)
        pf = frame
    return fig, displays, cropped_frames