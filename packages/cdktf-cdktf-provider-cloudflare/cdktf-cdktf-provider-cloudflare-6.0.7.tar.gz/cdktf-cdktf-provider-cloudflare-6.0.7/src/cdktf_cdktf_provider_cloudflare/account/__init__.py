...
class Account(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: The name of the account that is displayed in the Cloudflare dashboard. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.8.0/docs/resources/account#name Account#name}
        :param enforce_twofactor: Whether 2FA is enforced on the account. Defaults to ``false``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.8.0/docs/resources/account#enforce_twofactor Account#enforce_twofactor}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.8.0/docs/resources/account#id Account#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param type: Account type. Available values: ``enterprise``, ``standard``. Defaults to ``standard``. **Modifying this attribute will force creation of a new resource.**. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.8.0/docs/resources/account#type Account#type}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
