...
Environment: Type[rllte.common.distributed_agent.Environment]
...
class IMPALA(rllte.common.distributed_agent.DistributedAgent):
    ...
    def act(self, env: rllte.common.distributed_agent.Environment, actor_idx: int, free_queue, full_queue, init_actor_state_storages: list) -> None: ...
