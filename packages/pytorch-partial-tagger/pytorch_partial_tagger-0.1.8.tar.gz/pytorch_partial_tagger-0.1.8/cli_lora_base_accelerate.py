...
from partial_tagger.recognizer2 import Recognizer
from partial_tagger.training2 import Trainer
...
def train(
    ...
    return trainer(
        train_dataset, validation_dataset, accelerator, logger
    )  # type:ignore
...
def evaluate(
    ...
    predictions = recognizer(texts, batch_size, accelerator)
...
def main() -> None:
    ...
    train_log_file = "log_lora_base.jsonl"
    test_scores_file = "scores_lora_base.json"
