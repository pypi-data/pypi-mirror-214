.. container:: document
   ...
   IDE) <https://github.com/robotframework/RIDE/>`__ v2.0.7dev2 is a new
   ...
   *Linux users are advised to install first wxPython from .whl package
   ...
   .. code:: literal-block
      ...
      pip install --upgrade robotframework-ride==v2.0.7dev2
   ...
   RIDE v2.0.7dev2 was released on 10/Jun/2023.
