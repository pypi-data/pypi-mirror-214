...
__all__ = ( 'EKOX', 'EKON', 'STACK', 'EKO', 'TYPE', 'EKOI', 'EKOT', 'EKOH', 'EKOF', 'test', 'Bool', 'ntimes', 'LINE', 'resizeImage', 'count_parameters', 'parse_args', 'Counter', 'ENV', 'print_nothing', 'print_everything', 'noeko', 'NS', 'WARNING', 'INFO', 'ERROR', 'LOG', 'EKOIT', 'yeseko', 'ekostream', 'to_file', 'TIME',  'get_notebook_dir')
...
def get_notebook_dir() :
    ...
    results = subprocess.check_output(['find', "/content/gdrive/My Drive/", "-name", filename , "-print"]).decode('utf-8').strip()
