...
class IO(Config):
    ...
    def download_dbtable(self, hostname=None, db_user=None, db_passwd=None, db_name=None, port='3306', table_name=None, db_type='mysql', query=None):
        ...
        :param table_name: Name of target table
        :param db_type: Name of database type. Choose from mysql, mssql, postgres, mysql_legacy, sap_hana. Default mysql.
    ...
    def download_bigquery_table(self, project_id=None, tenant_id=None, table_name=None, gcp_key='datup-supplyai-dev-gcp.json'):
        """
        Method to Download tale form BigQuery
        :param projectId: Project identifier in GCP
        :param tenantId: Tenant or customer identifier
        :param table_name: BigQuery table name
        :param gcp_key: BigQuery credential key
        ...
        >>> df = download_bigquery_table(project_id='myproject', tenant_id='acme', table_name='mytable')
        >>> df
              var1    var2    var3
        idx0     1       2       3
        """
        ...
        try:
            sql = (f"SELECT * FROM {project_id}.{tenant_id}.{table_name}")
