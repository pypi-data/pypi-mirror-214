...
from typing import Any, List, Tuple, Dict, Iterable, Optional, Literal, Union, ClassVar, NoReturn, overload, Self
...
class RExecute(object):
    ...
    --------
    Select.
    >>> exe = RExecute(rengine)
    >>> result = exe.database.table()

    Insert.
    >>> exe = RExecute(rengine)
    >>> result = exe.database.table + data
    ...
    def __getattr__(self, name) -> Union[Any, Self]:
        """
