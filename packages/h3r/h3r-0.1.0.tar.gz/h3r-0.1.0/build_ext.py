...
EXTS = [
    ...
    Ext("EBI-Metagenomics", "h3r", "0.1.0", CMAKE_OPTS + CPM_OPTS),
]
...
if __name__ == "__main__":
    ...
    if not os.environ.get("H3R_DEVELOP", False):
        for ext in EXTS:
            build_ext(ext)

    libs = os.environ.get("H3R_LIBRARY_PATH", "").split(";")
    incls = os.environ.get("H3R_INCLUDE_PATH", "").split(";")
