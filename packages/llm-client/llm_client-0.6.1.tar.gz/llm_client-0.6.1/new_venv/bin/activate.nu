...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/uri/PycharmProjects/llm-client-sdk/new_venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/uri/PycharmProjects/llm-client-sdk/new_venv/bin/deactivate.nu'
