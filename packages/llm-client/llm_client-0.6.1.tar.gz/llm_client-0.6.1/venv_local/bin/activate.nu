...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/uri/PycharmProjects/llm-client-sdk/venv_local'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/uri/PycharmProjects/llm-client-sdk/venv_local/bin/deactivate.nu'
