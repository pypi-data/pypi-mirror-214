...
.. image:: https://img.shields.io/pypi/v/micropython-adxl343.svg
    ...
    :target: https://pypi.python.org/pypi/micropython-adxl343

.. image:: https://static.pepy.tech/personalized-badge/micropython-adxl343?period=total&units=international_system&left_color=grey&right_color=blue&left_text=Pypi%20Downloads
    :alt: Total PyPI downloads
    :target: https://pepy.tech/project/micropython-adxl343
...
PyPI <https://pypi.org/project/micropython-adxl343/>`_.
...
Documentation
=============
API documentation for this library can be found on `Read the Docs <https://micropython-adxl343.readthedocs.io/en/latest/>`_.
