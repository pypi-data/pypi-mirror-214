...
class TestGroupBy(SqlTestCase):
    ...
    def test_group_by_make_validation(self):
        ...
        self.assertErrorsWithMessage(
            ...
            ValueError,
            "There are columns in the input to .group_by() that do not belong to My.Test.Table:\n"
    ...
    def test_group_by_aggregate_validation(self):
        ...
        self.assertErrorsWithMessage(
            ...
            ValueError,
            "There are columns in the input to .agg that do not belong to My.Test.Table:\n"
